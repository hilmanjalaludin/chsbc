 ...
 */
 ...
 new Ext.Inialize("EUI").Helper(DeployLayout.core("EUI.AutoCall")); // tambahan process 
 ...
 */
 ...
 DeployLayout.load( DeployLayout.self("hsbctele.user") );
 DeployLayout.load( DeployLayout.self("metisMenu") );
 DeployLayout.load( DeployLayout.self("sb-hsbctele-2") );
