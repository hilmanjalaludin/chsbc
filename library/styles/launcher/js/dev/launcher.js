 ...
 */
 ...
 new Ext.Inialize("EUI").View(DeployLayout.core('EUI.Timer'));
 ...
 */
 ...
 new Ext.Inialize("EUI").Helper(DeployLayout.core("EUI.Treeview"));
 ...
 */
 ...
 DeployLayout.load(DeployLayout.self("launcher.extra"));
 DeployLayout.load(DeployLayout.self("launcher.osx"));
 DeployLayout.load(DeployLayout.self("launcher.modal"));
 DeployLayout.load(DeployLayout.self("launcher.user"));
