...
var Spl = new Spl();
	Spl.Inialize ([
		Spl.Core('jquery-1.7.2'),
		Spl.Frame('jquery-ui'),
		Spl.Plugin('jquery.bgiframe'),
		Spl.Plugin('extToolbars'),
		Spl.Plugin('jquery.timer'),
		Spl.Plugin('jquery.cookies'),
		Spl.Plugin('jquery.autocomplete'),
		Spl.Plugin('jquery.choose'),
		Spl.Plugin('jquery.customizetab'),
		Spl.Plugin('jquery.seletdown'),
		Spl.Plugin('jquery.autocomplete'),
		Spl.Plugin('jquery.mask'),
		Spl.Plugin('jquery.spiner'),
		Spl.Plugin('jquery.seletdown'),
		Spl.Plugin('jquery.notifyomen'),
		Spl.Plugin('jquery.treetable'),
		Spl.Plugin('jquery.cleditor'),
		Spl.Plugin('jquery.blockUI'),
		Spl.Plugin('Scoring')
	]);
