...
var start_timer_connected = function()
{
	...
	document.getElementById('lebel_counter').innerHTML = " <span style='font-size:13px;color:#3e7107;'> Talking \"</span>";
	var myTimer = function()
	{
		seconds+=1;
		document.getElementById("time_counter").innerHTML = "<span style='font-size:13px;color:#3e7107;font-weight:bold;'>"+seconds_to_time(seconds)+"</span>";
	}
}
...
var start_timer_ringing = function()
{
	...
	seconds = 0;
	intervalid = setInterval(function(){myTimer()},1000);
	document.getElementById('lebel_counter').innerHTML = " <span style='font-size:13px;color:#0b0bb1;'> Ringing \"</span>";
	var myTimer = function()
	{
		seconds+=1;
		document.getElementById("time_counter").innerHTML = "<span style='font-size:13px;color:#0b0bb1;font-weight:bold;'>"+seconds_to_time(seconds)+"</span>";
	}
}
...
var start_timer_acw = function()
{
	...
	seconds = 0;
	intervalid = setInterval(function(){myTimer()},1000);
	document.getElementById('lebel_counter').innerHTML = " <span style='font-size:13px;color:#b12003;'>ACW \"</span>";
	var myTimer = function()
	{
		seconds+=1;
		document.getElementById("time_counter").innerHTML = "<span style='font-size:13px;color:#b12003;font-weight:bold;'>"+seconds_to_time(seconds)+"</span>";
	}
}
