...
(function( $eui ){
 ...
 $eui.prototype.Role = function( $obj )
 {
	...
	({ 
		...
		Url : function( event ){
			var $url_post_role = new Array( this.$role, event ); 
			return $url_post_role;
		},
		...
		showMenu : function( action, object ){
			try{
				 Ext.ShowMenu( Role.Url(action), Ext.System.view_file_name(), object );
			} catch( e ){	 
				console.log(e);	
			}
		}
