...
/* 
 * @ pakage code  		 0b009
 * @ package 		 	 Product BNI Life Active Plus Modul Java Script Language
 ...
 function SetEventSubmit() 
{
 ...
 // ------------- save data policy ---> 
  ...
  Ext.Ajax   ({
		url 	: Ext.EventUrl(new Array('ProductBniLifeActivePlus','SaveDataEntry')).Apply(),
		method 	: 'POST',
...
function SelectCalculatorPremi( object )  
{
	var object = object, selector = 
	{
		listener : function() {
			return ( Ext.Ajax  ({
				url 	: Ext.EventUrl(new Array('ProductBniLifeActivePlus','SelectPremiPersonal')).Apply(),
				method 	: 'POST',
...
{
	return( Ext.Ajax ({
			url 	: Ext.EventUrl(new Array('ProductBniLifeActivePlus', 'SelectInsuredAge') ).Apply(), // +"/ProductForm/DOB/",
			method 	:'GET',
			param 	: { 
				Date  :  object.Date, 
...
{
	return( Ext.Ajax  ({
			url 	: Ext.EventUrl(new Array('ProductBniLifeActivePlus', 'SelectCalculateAge') ).Apply(), 
			method 	:'GET',
			param 	: { 
