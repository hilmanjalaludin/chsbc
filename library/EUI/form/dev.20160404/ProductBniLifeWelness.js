...
/* 
 * @ pakage code  		 0b009
 * @ package 		 	 Product BNI Life Welness Java Script Language
 ...
 function SetEventSubmit() 
{
 ...
 // ------------- save data policy ---> 
  ...
  Ext.Ajax   ({
		url 	: Ext.EventUrl(new Array('ProductBniLifeWelness','SaveDataEntry')).Apply(),
		method 	: 'POST',
...
function SelectCalculatorPremi( object )  
{
	var object = object, selector = 
	{
		listener : function() {
			return ( Ext.Ajax  ({
				url 	: Ext.EventUrl(new Array('ProductBniLifeWelness','SelectPremiPersonal')).Apply(),
				method 	: 'POST',
...
{
	return( Ext.Ajax ({
			url 	: Ext.EventUrl(new Array('ProductBniLifeWelness', 'SelectInsuredAge') ).Apply(), // +"/ProductForm/DOB/",
			method 	:'GET',
			param 	: { 
				Date  :  object.Date, 
...
{
	return( Ext.Ajax  ({
			url 	: Ext.EventUrl(new Array('ProductBniLifeWelness', 'SelectCalculateAge') ).Apply(), 
			method 	:'GET',
			param 	: { 
