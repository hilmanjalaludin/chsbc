 ...
 */
 ...
 function _ReadData( $file=null, $store_extended_info=true, $outputEncoding=null ) 
 {
	$this -> _ole =& OLERead::get_instance();
...
/*
 * @ def		called on helper methode not libraries
 *
 * @ package 	 view
 * @ params 	 Content line write
 */
...
if(!function_exists('ExcelImport')) 
{
	...
	{
		$OleRead =& EUI_ExcelImport::get_instance();
		if( $OleRead )
		{
			return $OleRead;
		}
