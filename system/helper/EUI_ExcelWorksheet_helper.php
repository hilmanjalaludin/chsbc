 ...
 * #######################################################################################
 *
 * chage && integrate by EUI Framework PHP 
 * author : omens < jombi_par@yahoo.com > 
 * ----------------------------------------------------------------------------------
 */
 
if( $UX_class =& get_instance() 
	AND !is_null($UX_class) ) 
{
	$UX_class->load->helper('EUI_ExcelBiffwriter');
	$UX_class->load->helper('EUI_ExcelFormat');
	$UX_class->load->helper('EUI_ExcelFormula');
	$UX_class->load->helper('EUI_ExcelOlewriter');
	$UX_class->load->helper('EUI_ExcelWorkbook');
}

/** 
 * this all parents include integrate by EUI Framework Easy load 
 * helper is inlcude ... :-))
 * then set this class 
 *
 */
