...
class M_Expireddata extends EUI_Model
{
...
// ------------------- post filter  --------------------------------------------------------------	
	...
	if ( _get_have_post("src_start_date") && _get_have_post("src_end_date") ) {
		$qty_start_date = _getDateEnglish(_get_post("src_start_date")) . " 00:00:00";
		$qty_end_date   = _getDateEnglish(_get_post("src_end_date")) . " 23:59:00";
		...
		$qty_end_date   = date("Y-m-d") . " 23:59:00";
		$this->EUI_Page->_setAnd( "a.CustomerUpdatedTs >= DATE_SUB('".$qty_end_date."', INTERVAL 3 MONTH)" );
		$this->EUI_Page->_setAnd( "a.CustomerUpdatedTs <= '".$qty_end_date."'" );
	}
...
function _get_content()
{
	...
	if ( _get_have_post("src_start_date") && _get_have_post("src_end_date") ) {
		...
		$conds3 = " a.CustomerUpdatedTs >= DATE_SUB('".$qty_end_date."', INTERVAL 3 MONTH) ";
		if( QUERY == 'mssql') {
			$conds3 = " a.CustomerUpdatedTs >= convert(varchar, DATEADD(month, -3, '{$qty_end_date}'), 120) ";
		}
