...
public function _get_default()
{
	...
	$this->EUI_Page->_setSelect("a.AssignId , h.StatusAccurate , if(i.CustomerId is not null , 'Yes' , 'No') as StatusScoring",FALSE);
	...
	$this->EUI_Page->_setJoin("t_gn_quality_assignment g ","g.Assign_Data_Id=a.AssignId","LEFT");
	...
	$this->EUI_Page->_setWhere("AND e.CallReasonId in(".CUSTOMER_LIST_AGENT.")" , "");
 ...
 */
 ...
 public function _get_content()
 {
	...
	$this->EUI_Page->_setArraySelect(array(
		...
		"if( i.CustomerId is not null , 'Yes' , 'No') as StatusScoring" =>  array("StatusScoring","Status Scoring"),
