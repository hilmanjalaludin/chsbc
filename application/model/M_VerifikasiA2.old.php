...
class M_VerifikasiA2 extends EUI_Model
{
	...
	function M_VerifikasiA2(){
		$this->_set_a = array('cust_dob_2nd');
	...
	function _get_value_verification($_cust_id){
		...
		$sql = "SELECT a.CustomerDOB, a.CustomerHomePhoneNum, a.CustomerMobilePhoneNum, a.CustomerWorkPhoneNum, a.card_no, a.credit_limit, a.due_date,
					a.card_exp, a.flag_suplement, a.billing_address, a.cycle_due_date, a.pil_acc_no, a.CampaignId, a.monthly_installment, fx.AddressVerif
				FROM t_gn_customer a left join t_gn_frm_flexi fx on a.CustomerId=fx.CustomerId
	...
	function _get_res_activity($cust_id,$ver_date){
		...
		$sql = "select a.ver_set, a.ver_status, count(a.id) as ver_total from t_gn_ver_activity a
				where 1=1 and a.cust_id = '".$cust_id."' group by a.ver_set, a.ver_status";
		$qry = $this->db->query($sql);
