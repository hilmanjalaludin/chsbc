...
class M_VerifikasiA2 extends EUI_Model
{
	...
	function _save_ver_activity($param, $type) {
		...
		if ($type == 'ask_1') {
			...
			$_input = $param['statement_2nd'].'|'.$param['email_2nd'];
			}else{
			$_value = $rowCustomer[0]->E_STATEMENT_FLAG;
			$_input = $param['statement_2nd'];	
			}
		} else if ($type == 'ask_3') {
			...
			if ($rowCustomer[0]->flag_suplement==0) {
				...
				if($rowCustomer[0]->Supp_Name_1==$param['total_additional_cc_2nd']){
	                $supp_name=$rowCustomer[0]->Supp_Name_1;
				} else
				if($rowCustomer[0]->Supp_Name_2==$param['total_additional_cc_2nd']){
	                $supp_name=$rowCustomer[0]->Supp_Name_2;
				} else
				if($rowCustomer[0]->Supp_Name_3==$param['total_additional_cc_2nd']){
	                $supp_name=$rowCustomer[0]->Supp_Name_3;
				} else 
				if($rowCustomer[0]->Supp_Name_4==$param['total_additional_cc_2nd']){
	                $supp_name=$rowCustomer[0]->Supp_Name_4;
				} else 
				if($rowCustomer[0]->Supp_Name_5==$param['total_additional_cc_2nd']){
	                $supp_name=$rowCustomer[0]->Supp_Name_5;
				} else {

					$supp_name=$this->veractivity_hilman($param['total_additional_cc_2nd'],$rowCustomer[0]->Supp_Name_1);
					if($supp_name==null){
						$supp_name=$this->veractivity_hilman($param['total_additional_cc_2nd'],$rowCustomer[0]->Supp_Name_2);
						if($supp_name==null){
							$supp_name=$this->veractivity_hilman($param['total_additional_cc_2nd'],$rowCustomer[0]->Supp_Name_3);
							if($supp_name==null){
								$supp_name=$this->veractivity_hilman($param['total_additional_cc_2nd'],$rowCustomer[0]->Supp_Name_4);
								if($supp_name==null){
									$supp_name=$this->veractivity_hilman($param['total_additional_cc_2nd'],$rowCustomer[0]->Supp_Name_5);
								}
							}	
			...
			$_value = $rowCustomer[0]->flag_suplement.'|'.$supp_name;
			...
			if($param['jenis_cc_2nd']==1){
				$card="Classic Card";
			}elseif($param['jenis_cc_2nd']==2){
				$card="Gold Card";
			}elseif($param['jenis_cc_2nd']==3){
				$card="Cashback Card";
			}elseif($param['jenis_cc_2nd']==4){
				$card="Platinum Card";
			}elseif($param['jenis_cc_2nd']==5){
				$card="Signature Card";
			}elseif($param['jenis_cc_2nd']==6){
				$card="Premier Card";
			}else{
				$card="0";
			}
			...
			$_input = $param['total_jenis_cc_2nd'].'|'.$card;
			...
			// if ($workNumberCut == $paramz['no_telp']) {
