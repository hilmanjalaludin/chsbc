...
class M_SrcCustomerListFlexi extends EUI_Model
{
...
function _get_default()
{
	...
	$this->EUI_Page->_setJoin("t_gn_customer c "," a.CustomerId=c.CustomerId", "INNER");
	...
	$this->EUI_Page->_setAnd("a.CampaignId", '9', TRUE);
	...
	if( in_array(_get_session('HandlingType'), array(USER_SUPERVISOR))) {
		$this->EUI_Page->_setAnd("h.spv_id", _get_session('UserId'));
	}
...
function _get_content()
{
	...
	$this->EUI_Page->_setJoin("t_gn_campaign d "," a.CampaignId=d.CampaignId", "LEFT");
	$this->EUI_Page->_setJoin("t_gn_customer c "," a.CustomerId=c.CustomerId", "INNER");
	$this->EUI_Page->_setJoin("tms_agent e "," a.SellerId=e.UserId", "LEFT");
	$this->EUI_Page->_setJoin("t_gn_ver_result g "," a.CustomerId=g.cust_id", "LEFT");
	$this->EUI_Page->_setJoin("t_lk_callreason f "," a.CallReasonId = f.CallReasonId", "LEFT", TRUE);
// ------------------------- defualt filter ------------------------	
	...
	if( in_array(_get_session('HandlingType'), 
		...
		$this->EUI_Page->_setAnd("e.spv_id", _get_session('UserId'));
	}
