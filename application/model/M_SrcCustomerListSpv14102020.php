     ...
     */
        ...
        function _get_content()
        {
            ...
            $this->EUI_Page->_setArraySelect(array(
                ...
                "( select ag.init_name from tms_agent ag where ag.UserId = a.SellerId ) as UserId" => array("UserId", "Agent ID"),
                "(select ag.init_name from tms_agent ag where ag.UserId = b.AssignSpv) as Supervisor" => array("Supervisor", "Supervisor"),
                "(select ag.init_name from tms_agent ag where ag.UserId = a.SellerId) as UpdatedById" => array("UpdatedById", "Updated By Agent"),
        ...
        END) = '100') THEN 'FULL'
          ...
          WHEN ((
            ...
            WHEN a.CampaignId=17 THEN cip.LoansVar 
            WHEN a.CampaignId=20 THEN cip.LoansVar 
            WHEN a.CampaignId=1012 THEN fs.vartiering
            WHEN a.CampaignId=6 THEN up.vartiering END) < '100') THEN 'LOWER LIMIT'
           
            WHEN a.CampaignId=1013 THEN 'NULL'
        ...
        ELSE 'LOWER LIMIT' END AS vartier" => array("vartier", "Var Tiering"),
            ...
            $this->EUI_Page->_setJoin("t_gn_frm_flexi_single fs", "fs.CustomerId = a.CustomerId", "LEFT");

            $this->EUI_Page->_setJoin("t_gn_frm_best_bill bs", "bs.CustomerId = a.CustomerId", "LEFT");
