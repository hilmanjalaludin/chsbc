...
class M_VerifikasiA2 extends EUI_Model
{
	...
	function _save_ver_activity($param, $type) {
		...
		if ($type == 'ask_1') {
			...
			}else if($rowCustomer[0]->Supp_Name_2==$param['total_additional_cc_2nd']){
				$supp_name=$rowCustomer[0]->Supp_Name_2;
			}else if($rowCustomer[0]->Supp_Name_3==$param['total_additional_cc_2nd']){
				$supp_name=$rowCustomer[0]->Supp_Name_3;
			}else if($rowCustomer[0]->Supp_Name_4==$param['total_additional_cc_2nd']){
				$supp_name=$rowCustomer[0]->Supp_Name_4;
			}else if($rowCustomer[0]->Supp_Name_5==$param['total_additional_cc_2nd']){
				$supp_name=$rowCustomer[0]->Supp_Name_5;
			}else{
				if ($rowCustomer[0]->flag_suplement==0) {
					$supp_name=0;
				}else{
					$supp_name1=$rowCustomer[0]->Supp_Name_1==null?'null':$rowCustomer[0]->Supp_Name_1;
					$supp_name2=$rowCustomer[0]->Supp_Name_2==null?'null':$rowCustomer[0]->Supp_Name_2;
					$supp_name3=$rowCustomer[0]->Supp_Name_3==null?'null':$rowCustomer[0]->Supp_Name_3;
					$supp_name4=$rowCustomer[0]->Supp_Name_4==null?'null':$rowCustomer[0]->Supp_Name_4;
					$supp_name5=$rowCustomer[0]->Supp_Name_5==null?'null':$rowCustomer[0]->Supp_Name_5;
	
					$supp_name=$supp_name1."|".$supp_name2."|".$supp_name3."|".$supp_name4."|".$supp_name5."|";
				}
