...
// --------------------- like ist ----------------------------
	...
	foreach( $qry ->result_assoc() as $rows )
 {
	...
	if( in_array( $rows['toolbar_code'], array_keys( $arrToolbar )) 
		&& $cnt_label_toolbars > 0 )
	{
		$xls = $no;
		...
		$no = $xls;
		$arr_toolbar['option'] = array_merge($arr_toolbar['option'],$arr_label_toolbars);
