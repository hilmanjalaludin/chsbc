...
class M_VerifikasiA extends EUI_Model
{
	...
	function _save_ver_activity($param, $type) {
		...
		if ($type == 'ask_1') {
			...
			}else if($rowCustomer[0]->Supp_Name_2==$param['total_additional_cc']){
				$supp_name=$rowCustomer[0]->Supp_Name_2;
			}else if($rowCustomer[0]->Supp_Name_3==$param['total_additional_cc']){
				$supp_name=$rowCustomer[0]->Supp_Name_3;
			}else if($rowCustomer[0]->Supp_Name_4==$param['total_additional_cc']){
				$supp_name=$rowCustomer[0]->Supp_Name_4;
			}else if($rowCustomer[0]->Supp_Name_5==$param['total_additional_cc']){
