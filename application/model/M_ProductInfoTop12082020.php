<?php
    class M_ProductInfoTop extends EUI_Model
    {
        ...
        function _get_data_loans($custid, $tenor = NULL){
            ...
            foreach( $qry -> result_assoc() as $rows ) {
                if($tenor!=NULL){
                    ...
                    // die;
                    $_datap['LoanAmount'] =  $rows['Loan'] == null ? $rows['LoanAmount'] : $rows['Loan'];
        ...
        //              var_dump('asd');
        $_datap[$rows['Tenor']]['LoanAmount'] = $rows['Loan'] == null ? $rows['LoanAmount'] : $rows['Loan'];
        // $_datap[$rows['Tenor']]['Installment'] = $rows['Installment'];
    // echo "<pre>";
    //              var_dump($rows['Loan']);
               
                    // edit hilman&andi start
                    $_datap[$rows['Tenor']]['DisburseAmount'] = $rows['DisburseAmount_1'] == null ? $rows['DisburseAmount'] : $rows['DisburseAmount_1'];
                    $_datap[$rows['Tenor']]['Installment'] =  $rows['INSTALL'] == null ? $rows['Installment'] : $rows['INSTALL'];
