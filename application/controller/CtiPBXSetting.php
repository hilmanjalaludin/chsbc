<?php
class CtiPBXSetting extends EUI_Controller
{

 function CtiPBXSetting() 
 {
	parent::__construct();
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_pbx_setting/view_pbxsetting_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_pbx_setting/view_pbxsetting_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function Add()
 {
	...
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_pbx_setting/view_pbxsetting_add',
			array
			(
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('cti_pbx_setting/view_pbxsetting_edit',$UI);
	}
