<?php
class CtiCCSetting extends EUI_Controller
{

 function CtiCCSetting() 
 {
	parent::__construct();
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_cc_setting/view_ccsetting_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_cc_setting/view_ccsetting_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function Add()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_cc_setting/view_ccsetting_add',
			array
			(
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('cti_cc_setting/view_ccsetting_edit',$UI);
	}
