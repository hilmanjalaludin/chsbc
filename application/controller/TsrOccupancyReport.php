<?php
	class TsrOccupancyReport extends EUI_Controller
	{
	
		function TsrOccupancyReport()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_TsrOccupancyReport'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_TsrOccupancyReport -> FilterBy(),
				'mode_by'		=> $this -> M_TsrOccupancyReport -> ModeBy()
			);
			$this -> load -> view("rpt_tsr_occupancy/rpt_tsr_occupancy_nav", $UI);
		}
		...
		public function Summary()
		{
			...
			$this -> load -> view("rpt_tsr_occupancy/rpt_tsr_occupancy_show", $UI);
		}
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_TsrOccupancyReport -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_TsrOccupancyReport->filter_by($v); 	
			}
			return $_reqs; 	
		}
