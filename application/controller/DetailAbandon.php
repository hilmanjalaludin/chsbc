...
class DetailAbandon extends EUI_Controller
{
...
{
	parent::__construct();
	$this->load->model(array('M_DetailAbandon', 'M_SetCallResult','M_SetProduct', 'M_SetCampaign','M_SetResultCategory', 'M_Combo', 'M_SysUser', 'M_MgtLockCustomer' ));
...
function ViewAddReferral()
{
	...
	if( is_array($Data) ) {
		$this->load->view('mod_detail_abandon/view_add_referral',$Data);
	}
}
...
function setCallResult() 
{
	$_result = array( "setCallResult" => $this -> getCallResult( _get_post('CategoryId') ) );
	 if( is_array($_result)) 
	{
		$this -> load ->view('mod_detail_abandon/view_call_result',$_result);
	}
}
 ...
 public function ContactDetail()
{
	 ...
	 if(  _get_have_post('CustomerId') )
	{
		...
		{
			$this->load->view('mod_detail_abandon/view_contact_main_detail', array(
