<?php
class CtiIVR extends EUI_Controller
{
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_ivr_view/view_ivr_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_ivr_view/view_ivr_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function Add()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_ivr_view/view_ivr_add',
			array
			(
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('cti_ivr_view/view_ivr_edit',$UI);
	}
