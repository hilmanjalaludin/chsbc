<?php
class CtiPBX extends EUI_Controller
{
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_pbx_view/view_pbx_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_pbx_view/view_pbx_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function Add()
 {
	...
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_pbx_view/view_pbx_add',
			array
			(
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('cti_pbx_view/view_pbx_edit',$UI);
	}
