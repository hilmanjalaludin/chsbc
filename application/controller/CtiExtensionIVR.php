<?php
class CtiExtensionIVR extends EUI_Controller
{

 function CtiExtensionIVR() {
	parent::__construct();
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_extension_ivr/view_ivr_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_extension_ivr/view_ivr_list',$_EUI);
		}	
	}	
 }
 ...
 */
 function Add()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_extension_ivr/view_ivr_add',
			array
			(
				'FieldName' => $this -> {base_class_model($this)}-> _getFieldName(),
				'PBX' 		=> $this -> {base_class_model($this)}-> _getPBXList(),
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('cti_extension_ivr/view_ivr_edit',$UI);
	}
