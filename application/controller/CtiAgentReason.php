<?php
class CtiAgentReason extends EUI_Controller
{


function CtiAgentReason() 
{
	parent::__construct();
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('cti_view_reason/view_reason_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('cti_view_reason/view_reason_list',$_EUI);
		}	
	}	
 }
 ...
 */
 function Add()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('cti_view_reason/view_reason_add',array());
	}
 }
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		$UI = array('Reason' => $this -> {base_class_model($this)}->_getReasonTypeData($this -> URI->_get_post('Id')) );
		
		$this -> load -> view('cti_view_reason/view_reason_edit',$UI);
	}
