<?php
	class RealTimeInboundReport extends EUI_Controller
	{
	
		function RealTimeInboundReport()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_RealTimeInboundReport'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_RealTimeInboundReport -> FilterBy(),
				'mode_by'		=> $this -> M_RealTimeInboundReport -> ModeBy()
			);
			$this -> load -> view("rpt_real_time_inbound/rpt_real_time_inbound_nav", $UI);
		}
		...
		public function Summary()
		{
			...
			$this -> load -> view("rpt_real_time_inbound/rpt_real_time_inbound_show", $UI);
		}
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_RealTimeInboundReport -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_RealTimeInboundReport->filter_by($v); 	
			}
			return $_reqs; 	
		}
