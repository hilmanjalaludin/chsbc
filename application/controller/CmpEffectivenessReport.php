<?php
	class CmpEffectivenessReport extends EUI_Controller
	{
	
		function CmpEffectivenessReport()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_CmpEffectivenessReport'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_CmpEffectivenessReport -> FilterBy(),
				'mode_by'		=> $this -> M_CmpEffectivenessReport -> ModeBy()
			);
			$this -> load -> view("rpt_campaign_effectiveness/rpt_campaign_effectiveness_nav", $UI);
		}
		...
		public function Summary()
		{
			...
			$this -> load -> view("rpt_campaign_effectiveness/rpt_campaign_effectiveness_show", $UI);
		}
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_CmpEffectivenessReport -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_CmpEffectivenessReport->filter_by($v); 	
			}
			return $_reqs; 	
		}
