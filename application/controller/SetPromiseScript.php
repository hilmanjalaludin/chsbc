...
class SetPromiseScript extends EUI_Controller
{
 ...
 */
 ...
 function index()
 {
	...
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI) ) 
		{
			$this -> load -> view('SetPromiseScript/view_product_script_nav',$_EUI);
		}	
	}	
 }
...
function Content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('SetPromiseScript/view_product_script_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function AddScript()
 {
	...
	$this -> load -> view("SetPromiseScript/view_product_script_add",$UI);
 }
...
// test
  public function ShowProductScriptView()
 {

 	// var_dump('test',$obScr->_getDataScriptView('ScriptId'));
 	// die();
	if( _get_have_post('ScriptId') ) 
	{
		...
		$obScr =& get_class_instance(base_class_model($this));
		$this->load->view("SetPromiseScript/view_product_showView",array (
			 'Data' => $obScr->_getDataScriptView('ScriptId')
		));

	}else{
        $obScr =& get_class_instance(base_class_model($this));
        // var_dump( 'Data' => $obScr->_getDataScriptView('ScriptId'));
        // die();
		$this->load->view("SetPromiseScript/view_product_showView",array (
			 'Data' => $obScr->_getDataScriptView('ScriptId')
		));		
...
// test
  public function ShowProductScript()
 {
	...
	{
		$obScr =& get_class_instance(base_class_model($this));
		$this->load->view("SetPromiseScript/view_product_show",array (
