<?php
class GroupCallCenterReport extends EUI_Controller
{

 function GroupCallCenterReport() {
	parent::__construct();
 ...
 function index()
 {
	...
	$this -> load -> view("rpt_group_callcenter/report_call_center_nav", $UI);
 }
 ...
 public function Hourly()
 {
	$UI = array
	(
		'view'  => $this ->{base_class_model($this)}->_getHourly($this -> _POST()), 
		'param' => $this -> _POST(),
		'Users' => $this -> _AGENT()	
	);
	
	$this -> load -> view("rpt_group_callcenter/report_call_center_hourly", $UI);
 }
 ...
 public function Daily()
 {
	...
	$this -> load -> view("rpt_group_callcenter/report_call_center_daily", $UI);
 }
 ...
 public function Summary()
 {
	...
	$this -> load -> view("rpt_group_callcenter/report_call_center_summary", $UI);
 }
