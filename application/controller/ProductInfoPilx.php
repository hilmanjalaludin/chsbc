<?php
class ProductInfoPilx extends EUI_Controller
{
	function ProductInfoPilx()
	{
		parent::__construct();
	...
	function index()
	{
		$this->load->form('product_info_pilx/view_form_default',array(
	...
	function saveLoan(){
		...
		$obClass =& get_class_instance(base_class_model($this));
		if( $obClass->_set_row_save_pilx( $loans ) ){
			echo json_encode( array('success' => 1));
			return true;
		}
