<?php
class QaApprovedList extends EUI_Controller
{
	function QaApprovedList()
	{
		parent::__construct();
	...
	function index()
	{
		...
		{
			$this->load ->view('qa_approved_list/view_approval_nav',array(
	...
	function Content()
	{
		if( $this -> EUI_Session -> _have_get_session('UserId') )
		{
			...
			{
				$this -> load -> view('qa_approved_list/view_approval_list',$_EUI);
			}
		}
	}
