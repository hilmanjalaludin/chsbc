<?php
	class  	BroadMarketingCmpRpt extends EUI_Controller
	{
	
		function  	BroadMarketingCmpRpt()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_BroadMarketingCampaignReport'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_BroadMarketingCampaignReport -> FilterBy(),
				'mode_by'		=> $this -> M_BroadMarketingCampaignReport -> ModeBy()
			);
			$this -> load -> view("rpt_broad_marketing_campaign/rpt_broad_marketing_campaign_nav", $UI);
		}
		...
		public function Summary()
		{
			...
			$this -> load -> view("rpt_broad_marketing_campaign/rpt_broad_marketing_campaign_show", $UI);
		}
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_BroadMarketingCampaignReport -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_BroadMarketingCampaignReport->filter_by($v); 	
			}
			return $_reqs; 	
		}
