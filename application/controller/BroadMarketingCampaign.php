<?php
	class BroadMarketingCampaign extends EUI_Controller
	{
	
		function BroadMarketingCampaign()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_BroadMarketingCampaign'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_BroadMarketingCampaign -> FilterBy(),
				'mode_by'		=> $this -> M_BroadMarketingCampaign -> ModeBy()
			);
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_BroadMarketingCampaign -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_BroadMarketingCampaign->filter_by($v); 	
			}
			return $_reqs; 	
		}
