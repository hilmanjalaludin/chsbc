<?php
	class QAOnLeadReport extends EUI_Controller
	{
	
		function QAOnLeadReport()
		{
			parent::__construct();
			$this -> load -> model(array(base_class_model($this),'M_QAOnLeadReport'));
		}
		...
		function index()
		{
			$UI = array
			(
				'filter_by'		=> $this -> M_QAOnLeadReport -> FilterBy(),
				'mode_by'		=> $this -> M_QAOnLeadReport -> ModeBy()
			);
			$this -> load -> view("rpt_QA_On_Lead/rpt_QA_On_Lead_nav", $UI);
		}
		...
		public function Summary()
		{
			...
			$this -> load -> view("rpt_QA_On_Lead/rpt_QA_On_Lead_show", $UI);
		}
		...
		public function getCampaign()
		{
			...
			{
				$_conds = $this -> M_QAOnLeadReport -> filter_by($this -> URI->_get_post('FilterId'));
		...
		public function _CAMPAIGN()
		{
			...
			{
				$_reqs[$v] = $this ->M_QAOnLeadReport->filter_by($v); 	
			}
			return $_reqs; 	
		}
