<?php
class SetDIDNumber extends EUI_Controller
{

 function SetDIDNumber() 
 {
	parent::__construct();
 ...
 */
 ...
 function index()
 {
	if( $this ->EUI_Session -> _have_get_session('UserId') )
	{
		...
		if( is_array($_EUI))
		{
			$this -> load -> view('mod_did_view/view_did_nav',$_EUI);
		}	
	}	
 }
...
function content()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		...
		{
			$this -> load -> view('mod_did_view/view_did_list',$_EUI);
		}	
	}	
 }
 ...
 */
 ...
 function Add()
 {
	...
	if( $this -> EUI_Session -> _have_get_session('UserId') )
	{
		$this -> load -> view('mod_did_view/view_did_add',
			array
			(
 ...
 */
 ...
 function Edit()
 {
	if( $this -> EUI_Session -> _have_get_session('UserId') ) 
	{
		...
		$this -> load -> view('mod_did_view/view_did_edit',$UI);
	}
