...
<?php echo form()->legend(lang("Option"),"fa-gear");?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Dist.Campaign PDS");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("dis_campaign_name_pds", "select tolong", CampaignIdPds(),NULL);?></div>
		</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell">
				<?php echo form()->button("BtnDistData", "button assign",lang("Submit To PDS"), array("click" => "Ext.DOM.SubmitDistribute();"));?>
				<!--?#php echo form()->button("BtnClearPDS", "button assign",lang("Clear PDS Campaign"), array("click" => "Ext.DOM.ClearPDSCampaign();"));?-->
			</div>
		</div>
	</div>
	</form>
