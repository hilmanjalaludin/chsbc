 ...
 */
 ...
 $spiner->set_name_table("ui-widget-pager-dis-list");
...
$spiner->set_checkbox_table(array('field' =>'DistAssignId',  'event' => null ));
 
 //---------------------------------------------------------------------------------------

//var_dump($spiner->select_pager_debug());
...
// ---- call back func argv 
 ...
 $spiner->set_field_call_back(array(
	...
	"Recsource" 		 	=> array("strtoupper"),
	"CustomerFirstName"  	=> array("strtoupper"),
