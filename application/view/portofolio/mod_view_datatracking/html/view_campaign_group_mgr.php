...
//----------------- utilize data new ----------
 ...
 if( $rs->num_rows() > 0 ) 
	 foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignAmgr']]['data_new_utilize'] += $rows['data_new_utilize'];
 } 
 ...
 if( $rs->num_rows() > 0 ) 
	 foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignAmgr']]['data_old_utilize'] += $rows['data_old_utilize'];
 } 
...
// --------- get datat DB ---
 ...
 $call_data_content = $data[$ManagerId];
 ...
 function showheaders()
{
	echo "<div class=\"center\">".
		 "<p class=\"normal font-size22\">Report Data Tracking - Campaign Group By MGR</p>".
