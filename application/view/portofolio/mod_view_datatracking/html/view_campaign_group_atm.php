...
//----------------- utilize data new ----------
 ...
 if( $rs->num_rows() > 0 ) 
	 foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignSpv']]['data_new_utilize'] += $rows['data_new_utilize'];
 } 
 ...
 if( $rs->num_rows() > 0 ) 
	 foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignSpv']]['data_old_utilize'] += $rows['data_old_utilize'];
 } 
...
//----------------- utilize data new ----------
 ...
 $UI->db->where_in("d.UserId", array_map('intval', array($AtmId)) );
 ...
 function showheaders()
{
	echo "<div class=\"center\">".
		 "<p class=\"normal font-size22\">Report Data Tracking - Campaign Group By ATM</p>".
