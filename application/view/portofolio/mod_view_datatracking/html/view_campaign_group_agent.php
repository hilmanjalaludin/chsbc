 ...
 function _select_campaign_group_agent_summary()
{
 ...
 $TmrId = $Out->get_array_value("TmrId");
...
//----------------- utilize data new ----------
 ...
 $UI->db->where_in("b.CampaignId", $CampaignId);
 $UI->db->where_in("CreatedById", array_map('intval', $Out->get_array_value('TmrId')));
	 ...
	 foreach( $rs->result_assoc() as $rows ) 
{
 ...
 // ---------- get data talktime --------------
  ...
  $UI->db->where_in("c.AssignSelerId", array_map('intval', $Out->get_array_value('TmrId')));
 ...
 function showheaders()
{
	...
	echo "<div class=\"center\">".
		 "<p class=\"normal font-size22\">Report Data Tracking - Campaign Group By TMR</p>".
