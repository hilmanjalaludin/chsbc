 ...
 <form name="frmReport">
	<div class="ui-widget-form-table-compact">
		...
		<div id="ui-widget-row1" class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption" id="ui-widget-label-row0">RecsourceId</div>
			<div class="ui-widget-form-cell text_caption center" id="ui-widget-separator-row0">:</div>
			<div class="ui-widget-form-cell" id="ui-widget-content-row0"><?php echo form()->chooseall('RecsourceId','select tolong',  $report_recsource);?></div>
		</div>
