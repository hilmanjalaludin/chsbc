...
?>
<title>Call Tracking Summary per SPV</title>
Call Tracking Summary by Recsource per SPV Periode of <?php echo dateAsal($param['start_date']); ?> to <?php echo dateAsal($param['end_date']); ?> <br>
...
<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;'>
	...
	<tr class=xl74>
		...
		<td class=xl86><?php echo round($PercentageUtil,2); ?>%</td>
		...
		<td class=xl86 align = "right"><?php echo $PercentageCont; ?>%</td>
		...
		<td class=xl86><?php echo $PercentageUn; ?>%</td>
		<?php
