...
Ext.DOM.navigation = 
{
	custnav  : Ext.DOM.INDEX+'/QaApprovalList/index/',
	custlist : Ext.DOM.INDEX+'/QaApprovalList/Content/',
}
...
Ext.DOM.SetFollowUp = function(CustomerId)
{
	var data = Ext.Ajax
	({
		url 	: Ext.EventUrl(['QaApprovalList','SetFollowup']).Apply(),
		method  : 'POST',
		param	: {
...
Ext.DOM.gotoDetailQA = function(CustomerId)
{
	if( CustomerId!='') 
	{
		...
		if( response.success == 1){
			...
			Ext.ShowMenu( new Array('QaApprovalList','ContactDetail'), 
			Ext.System.view_file_name(), 
			{
				CustomerId : CustomerId,
				ControllerId : 'QaApprovalList'
			}); 
		} else {
