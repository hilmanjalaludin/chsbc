<style>
	.group_go{
		background: url('<?php echo base_url()."library/gambar/icon/group_go.png"?>') no-repeat top left !important;
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row baris1">
			...
			<!-- <div class="ui-widget-form-cell text_caption left"> 
				<?php //echo form()->input('src_start_date','input_text date',_get_exist_session('src_start_date'));?>
		...
		<!-- <div class="ui-widget-form-row baris1" style="margin-top:-12px;">
			<div class="ui-widget-form-cell text_caption" style="margin-top:-12px;"> </div>
			<div class="ui-widget-form-cell center" style="margin-top:-12px;"></div>
			<div class="ui-widget-form-cell" style="margin-top:-12px;"> <?php #echo form()->button("btnNextCustomer", "button input-chart btn-max ui-data-disabled", lang('Next Customer'), array('click' => 'Ext.DOM.NextCustomer();'));?> </div>
		</div> -->		
	 </div>
