...
Ext.DOM.saveActivity =function(val_2nd=''){
	value_2nd = val_2nd;
	//console.log("## saveActivity123",Ext.Cmp('InputForm').getValue());
	//return false;
	...
	if(firstProd){
		...
		*/
		...
		// console.log('tes',Ext.Cmp('InputForm').getValue());
		console.log("## saveActivity123",Ext.Cmp('InputForm').getValue());
		if( CallEventTriger.event.CallReasonEvent == 1 ){
			
		console.log('Ext.Cmp.getValue()', Ext.Cmp('InputForm').getValue())
		console.log('Ext.Cmp.getValue()_2nd', Ext.Cmp('InputForm_2nd').getValue())
			//edit irul
