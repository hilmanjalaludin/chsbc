...
<?php $this ->load ->view('mod_contact_detail/view_contact_javascript');?>
	...
	<div class="ui-widget-form-table-compact" style="width:99%;">
		<div class="ui-widget-form-row" style="vertical-align:top;">
			<div class="ui-widget-form-cell">
				<?php $this->load->view('mod_contact_detail/view_contact_default_detail');?>
				<?php $this->load->view('mod_contact_detail/view_contact_history_detail');?>
			</div>
			<div class="ui-widget-form-cell" style="vertical-align:top;">
				<?php $this ->load ->view('mod_contact_detail/view_contact_phone_detail');?>
			</div>
		</div>
	</div>
	<!-- stop : detail -->
