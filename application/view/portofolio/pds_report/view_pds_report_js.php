<script>
	...
	Ext.DOM.DoSomething=function()
	{
		...
		(
			{
				url		: Ext.DOM.INDEX +'/ReportPDS/Load1/',
				param	:  {
	...
	Ext.DOM.LoadRecsource=function()
	{
		...
		(
			{
				url		: Ext.DOM.INDEX +'/ReportPDS/LoadRecsource/',
				param	:  {
					group_type : Ext.Cmp('group_type').getValue(),
	...
	Ext.DOM.LoadTMO=function()
	{
		...
		(
			{
				url		: Ext.DOM.INDEX +'/ReportPDS/LoadTMO/',
				param	:  {
					group_type : Ext.Cmp('group_type').getValue(),
	...
	Ext.DOM.ShowReport=function()
	{
		...
		// } else {
			...
			(
				{
					url 	: Ext.DOM.INDEX +'/ReportPDS/ShowReport/',
					method : 'POST',
					param	: 	{
									Campaign : Campaign,
									Recsource : Recsource,
	...
	Ext.DOM.ShowExcel=function()
	{
		...
		// } else {
			...
			(
				{
					url 	: Ext.DOM.INDEX +'/ReportPDS/ShowExcel/',
					method : 'POST',
					param	: 	{
									Campaign : Campaign,
									Recsource : Recsource,
