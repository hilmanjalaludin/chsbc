...
<tr>
	...
	<td><?php echo form() -> combo('product', 'select', array('cip'=>'CIP','pil' => 'PIL','bestbill'=>'BEST BILL'),null,null,array('style'=>'height:21px;width:100px;color:#000000;border:1px solid red;')); ?></td>
</tr>			
<tr>
	<td>&nbsp;</td>
	<td> 
