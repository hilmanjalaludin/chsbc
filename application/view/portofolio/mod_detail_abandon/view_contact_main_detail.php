...
<?php $this ->load ->view('mod_detail_abandon/view_contact_javascript');?>

<!-- detail content -->
<fieldset class="corner" style="border-radius:5px;"> 
<?php echo form()->legend(lang('Review Detail'), "fa-user"); ?>
	...
	<div class="ui-widget-form-table-compact" style="width:99%;">
		<div class="ui-widget-form-row" style="vertical-align:top;">
			<div class="ui-widget-form-cell ui-widget-content-top">
				<?php $this->load->view('mod_detail_abandon/view_contact_default_detail');?>
				<?php $this->load->view('mod_detail_abandon/view_contact_history_detail');?>
			</div>
		</div>
	</div>
	<!-- stop : detail -->
