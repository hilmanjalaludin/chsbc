 ...
 <?php echo form()->hidden("CallingNumber",NULL, $Detail->get_value('CustomerMobilePhoneNum')); ?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell" id="DivAddPhone"><?php echo form()->combo('AddPhoneNumber','select tolong select-chosen',CustomerAdditionalPhone($Detail->get_value('CustomerId')), null, array("change" =>"Ext.Cmp('CallingNumber').setValue(this.value);Ext.Cmp('PhoneNumber').setValue('');")); ?></div>
		</div>
		...
		<div class="ui-widget-form-row baris1" style="margin-top:-12px;">
			...
			<div class="ui-widget-form-cell" style="margin-top:-12px;"> <?php echo form()->button("ButtonReload", "button input-chart btn-max", lang('Refresh'), array('click' => 'Ext.DOM.LoadAddPhone();'));?> </div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell">
				<?php  echo form()->button("btnDialCustomer","button dial ui-button-max", "Call", array("click" => "window.dialCustomer('Manual');") ); ?>
				<?php  echo form()->button("btnHanupCustomer","button hangup ui-button-max", "Hangup", array("click" => "window.hangupCustomer();")); ?>
			</div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center">:</div>
			<div class="ui-widget-form-cell" id="ui-disposition-parent"><?php echo form()->combo('CallStatus','select tolong select-chosen', OutboundCategory(),$Detail->get_value('CustomerStatus')); ?></div>
		</div>
		
		<div class="ui-widget-form-row baris1">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Call Result");?></div>
			<div class="ui-widget-form-cell center">:</div>
			<div class="ui-widget-form-cell" id="ui-disposition-result"> <?php echo form()->combo('CallResult','select tolong select-chosen',CallDisposition( $Detail->field('CallReasonId') ), $Detail->get_value('CallReasonId'),array('change'=>'getEventSale(this);')); ?></div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center"></div>
			<div class="ui-widget-form-cell">
				<?php echo form()->button("ButtonUserSave", "button save ui-button-max", lang('Save'), array('click' => 'Ext.DOM.saveActivity();'));?>
