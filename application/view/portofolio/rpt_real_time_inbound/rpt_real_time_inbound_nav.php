...
<script>
	...
	Ext.document(document).ready(function()
	{
		...
		Ext.DOM.ShowReport = function() 
		{
			...
			Ext.Window({
				url 	: Ext.DOM.INDEX +'/RealTimeInboundReport/ShowReport/',
				param 	: {
		...
		Ext.DOM.ShowExcel = function()
		{
			Ext.Window
			({
				url 	: Ext.DOM.INDEX +'/RealTimeInboundReport/ShowExcel/',
				param 	: { 
					start_date : Ext.Cmp('start_date').getValue(), 
					end_date : Ext.Cmp('end_date').getValue(),
					mode : Ext.Cmp('ModeBy').getValue(),
		...
		Ext.Ajax
		({
			url 	: Ext.DOM.INDEX +'/RealTimeInboundReport/getCampaign/',
			param 	: {
...
<fieldset class="corner">
	<legend class="icon-customers">&nbsp;&nbsp;<span id="legend_title">Real Time Inbound Report</span></legend>
<div id="panel-main-content">
	<table border=0 width='100%'>
		<tr>
			<td width='40%' valign="top"><?php $this -> load-> view('rpt_real_time_inbound/rpt_real_time_inbound_filter');?></td>
		</tr>
	</table>
</div>
</fieldset>