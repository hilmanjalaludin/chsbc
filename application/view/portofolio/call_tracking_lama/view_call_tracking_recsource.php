...
Call Tracking Summary by Recsource per TMR Periode of <?=$param['start_date']?> s/d <?=$param['end_date']?> <br>
...
<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;'>
	<tr>
		<td rowspan=2 class=xl66>Agent</td>
	...
	?>
	<tr class=xl74>
		<td class=xl75><?php echo $Recsource; ?></td>
		...
		<td class=xl72><?php echo round($PercentageUtil,2); ?></td>
		...
		<td class=xl72 align = "right"><?php echo $PercentageCont; ?></td>
		...
		<td class=xl72><?php echo $PercentageUn; ?></td>
		<?php
	...
	<tr>
		...
		<td class=xl66><?php echo round($sPerUtil[$ID]['sPerUtil'],2); ?> %</td>
		...
		<td class=xl66><?php echo round($sPerContact[$ID]['sPerContact'],2); ?> %</td>
		...
		<td class=xl66><?php echo round($sPerUncontact[$ID]['sPerUncontact'],2); ?> %</td>
		<?php
