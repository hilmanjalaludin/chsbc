 ...
 <?php echo form()->hidden("CallingNumber",NULL, $Detail->get_value('CustomerMobilePhoneNum')); ?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center"></div>
			<div class="ui-widget-form-cell">
				<span style="cursor:pointer;color:red;vertical-align:center;"><img class="image-calls" src="<?php echo base_url(); ?>/library/gambar/PhoneCall.png" width="35px" height="35px" style="cursor:pointer;" title="Dial..." > Call</span>	
				<span style="cursor:pointer;color:red;vertical-align:center;"><img class="image-hangup" src="<?php echo base_url(); ?>/library/gambar/HangUp.png" width="35px" height="35px" style="cursor:pointer;" title="Hangup..." > HangUp</span>
