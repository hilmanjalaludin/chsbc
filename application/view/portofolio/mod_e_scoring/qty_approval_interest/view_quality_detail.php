...
<?php $this ->load ->view('mod_e_scoring/qty_approval_interest/view_quality_javascript');?>
<?php $this ->load ->view('mod_e_scoring/qty_approval_interest/view_js_product');?>
<?php $this ->load ->view("mod_e_scoring/qty_approval_interest/view_scoring_js"); ?>
...
<div id="tabs-panels" style='border:1px solid #dddddd;'>
	...
	<ul>
		...
		<div id="tabs-panel-1" style="background-color:#FFFFFF;">
			<?php $this->load->view('mod_e_scoring/qty_approval_interest/view_customer_info');?>
		</div>
		...
		<?php 
			...
			$this->load->view('mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_header'   ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_section1" ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_section2" ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_section3" ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_section4" ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_section5" ,  $forwho);
			$this->load->view("mod_e_scoring/qty_approval_interest/view_form_scoring/view_quality_scoring_footer"   ,  $forwho);
		?>
		</div>
	...
	<?php $this ->load ->view('mod_e_scoring/qty_approval_interest/view_quality_history_detail');?>
