  ...
  Ext.DOM.SubmitPullData = function()
{
 ...
 Ext.DOM.CallStatCheck=function (params) {
	 var call=Ext.Cmp('pull_call_result_id').getValue()
	 console.log('CallStatCheck',call)
	var param=[];
	param['value'] = call;
	...
	if(param['Campaign']!=''||param['Campaign']!=0){
		...
		success  : function( xhr ){
			Ext.Util( xhr ).proc(function(xhr){
				...
				var cl=$('#disagree-selectdown').attr('class')
				console.log('ini cl',cl)
				if (cl=='toggle-notactive ui-down-active') {
					$('#disagree-selectdown').removeClass("toggle-notactive ui-down-active").addClass("toggle-active ui-down-active");
					document.getElementById("aading").innerHTML ="<select id='disagree' name='disagree' class='select tolong'><option value='Choose'>Choose</option></select><div id='textArea'></div>"
				...
				xhr.forEach(function (resp) {
					...
					$('#disagree-selectdown').removeClass("toggle-active ui-down-active").addClass("toggle-notactive ui-down-active");
					document.getElementById("aading").innerHTML =" <fieldset class='textarea' id='field_disagree' style='background-color:#fffcfd;border:1px solid #dddddd;width:100%'> <legend style='cursor:pointer;'><a href='javascript:void(0);' onclick='Ext.Cmp('disagree').setChecked();' title='select here' style='text-decoration:none;'><label style='cursor:pointer;margin-left:-7px;' class='ui-widget-field-select'><i class='fa fa-check-square-o' aria-hidden='true'></i> ALL</label></a></legend> <div id='div_disagree' style='resize:both;overflow:auto;height:100%;border:0px solid #eeeeee;background-color:#fffcfd'><div class='ui-widget-form-table-compact ui-widget-list-box-table' id='add2'></div></div> </div> </fieldset>";


					xhr.forEach(function (resp) {
								// console.log(resp.DisagreeCode)
								$('#add2').append( "<div class='ui-widget-form-row ui-widget-list-box-row ui-widget-list-box-cell-one'><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' style='width:10%;'> <input type='checkbox' class='' name='disagree' id='disagree' value='"+resp.DisagreeId+"' ></div><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' style='width:89%;'>"+resp.DisagreeDesc+"</div></div>")
								})
				}
...
Ext.DOM.CallStatCheck2=function (params) {
	var call2=Ext.Cmp('trans_call_result_id').getValue()
	 console.log('CallStatCheck',call2)
	...
	if(param['Campaign']!=''||param['Campaign']!=0){
		...
		success  : function( xhr ){
			Ext.Util( xhr ).proc(function(xhr){
				// console.log(xhr);
				// document.getElementById("aading").innerHTML = "New text!"
				var cl=$('#disagree-selectdown2').attr('class')
				console.log('ini cl',cl)
				if (cl=='toggle-notactive ui-down-active') {
					$('#disagree-selectdown2').removeClass("toggle-notactive ui-down-active").addClass("toggle-active ui-down-active");
					document.getElementById("aading2").innerHTML ="<select id='disagree2' name='disagree2' class='select tolong'><option value='Choose'>Choose</option></select><div id='textArea'></div>"
				...
				xhr.forEach(function (resp) {
					...
					$('#disagree-selectdown2').removeClass("toggle-active ui-down-active").addClass("toggle-notactive ui-down-active");
					document.getElementById("aading2").innerHTML =" <fieldset class='textarea' id='field_disagree2' style='background-color:#fffcfd;border:1px solid #dddddd;width:100%'> <legend style='cursor:pointer;'><a href='javascript:void(0);' onclick='Ext.Cmp('disagree2').setChecked();' title='select here' style='text-decoration:none;'><label style='cursor:pointer;margin-left:-7px;' class='ui-widget-field-select'><i class='fa fa-check-square-o' aria-hidden='true'></i> ALL</label></a></legend> <div id='div_disagree2' style='resize:both;overflow:auto;height:100%;border:0px solid #eeeeee;background-color:#fffcfd'><div class='ui-widget-form-table-compact ui-widget-list-box-table' id='add3'></div></div> </div> </fieldset>";


					xhr.forEach(function (resp) {
								// console.log(resp.DisagreeCode)
								$('#add3').append( "<div class='ui-widget-form-row ui-widget-list-box-row ui-widget-list-box-cell-one'><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' style='width:10%;'> <input type='checkbox' class='' name='disagree2' id='disagree2' value='"+resp.DisagreeId+"' ></div><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' style='width:89%;'>"+resp.DisagreeDesc+"</div></div>")
								})
				}
			});
		}
 ...
 Ext.DOM.CallStatCheckDis=function (params) {
	 var call=Ext.Cmp('dis_call_reason').getValue()
	 console.log('CallStatCheck3',call)
	var param=[];
	param['value'] = call;
	param['Campaign']=Ext.Cmp('dis_campaign_name').getValue()
	if(param['Campaign']!=''||param['Campaign']!=0){
		if(call==8){
		console.log('true',call)
		Ext.Ajax({
		...
		success  : function( xhr ){
			Ext.Util( xhr ).proc(function(xhr){
				...
				var cl=$('#disagree-selectdown3').attr('class')
				console.log('ini cl',cl)
				if (cl=='toggle-notactive-new ui-down-active-new') {
					$('#disagree-selectdown3').removeClass("toggle-notactive-new ui-down-active-new").addClass("toggle-active-new ui-down-active-new");
					document.getElementById("aading3").innerHTML ="<select id='disagree3' name='disagree3' class='select tolong'><option value='Choose'>Choose</option></select><div id='textArea'></div>"

				xhr.forEach(function (resp) {
					console.log(resp.DisagreeCode)
					$('#disagree3').append('<option value="'+resp.DisagreeId+'">'+resp.DisagreeDesc+'</option>')
                    })
					
				}else{
					$('#disagree-selectdown3').removeClass("toggle-active-new ui-down-active-new").addClass("toggle-notactive-new ui-down-active-new");
					document.getElementById("aading3").innerHTML =" <fieldset class='textarea' id='field_disagree3' style='background-color:#fffcfd;border:1px solid #dddddd;'> <legend style='cursor:pointer;'><a href='javascript:void(0);' onclick='Ext.Cmp('disagree3').setChecked();' title='select here' style='text-decoration:none;'><label style='cursor:pointer;margin-left:-7px;' class='ui-widget-field-select'><i class='fa fa-check-square-o' aria-hidden='true'></i> ALL</label></a></legend> <div id='div_disagree' style='resize:both;overflow:auto;height:100%;border:0px solid #eeeeee;background-color:#fffcfd'><div class='ui-widget-form-table-compact ui-widget-list-box-table' id='add4'></div></div> </div> </fieldset>";


					xhr.forEach(function (resp) {
								// console.log(resp.DisagreeCode)
								$('#add4').append( "<div class='ui-widget-form-row ui-widget-list-box-row ui-widget-list-box-cell-one'><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' > <input type='checkbox' class='' name='disagree3' id='disagree3' value='"+resp.DisagreeId+"' ></div><div class='ui-widget-form-cell ui-widget-list-box-cell table-white-space-ys-wrap left' style='width:89%;'>"+resp.DisagreeDesc+"</div></div>")
								})
				}
