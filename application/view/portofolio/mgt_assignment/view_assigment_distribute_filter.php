...
<?php echo form()->legend(lang("Filter Data"),"fa-search");?>
	...
	<div class="ui-widget-form-table" style="margin-top:-5px;">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell ui-widget-content-top text_caption left"><?php echo form() -> combo('dis_call_reason','select long', CallResultNotInterest(),null,array('change'=>'Ext.DOM.CallStatCheckDis(this)'));?></div>
