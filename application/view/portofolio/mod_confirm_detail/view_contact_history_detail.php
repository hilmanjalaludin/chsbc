<div style="overflow:auto;margin-top:15px;" class="contact-history">
	<div id="tabs" class="corner" class="history-tabs">
		<ul>
			<li class="ui-tab-li-lasted"><a href="#tabs-1">
			<span class="ui-icon ui-icon-person"></span><?php echo lang('Call History');?></a></li>
			
			<li class="ui-tab-li-lasted"><a href="#tabs-2">
			<span class="ui-icon ui-icon-video"></span><?php echo lang('Recording');?></a></li>
		</ul>
