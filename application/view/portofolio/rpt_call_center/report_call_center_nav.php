...
v//ar test = Ext.Cmp('Content_Filter').getValue();
//alert(test);
//exit;	
var TITLE = Ext.System.view_file_name() 
  ...
  // Ext.Dialog('panel-call-center', {
		...
		// type	: 'ajax/html',
		// title	: TITLE,
		// url 	: Ext.DOM.INDEX +'/CallCenterReport/ShowReport/',
		// param 	: { 
			// filter : Ext.Cmp('Filter').getValue(),  
	...
	Ext.Window({
		url 	: Ext.DOM.INDEX +'/CallCenterReport/ShowReport/',
		param 	: { 
			GroupCallCenter : Ext.Cmp('Filter').getValue(),  
			AgentId : Ext.Cmp('AgentId').getValue(),
			start_date : Ext.Cmp('start_date').getValue(), 
			end_date : Ext.Cmp('end_date').getValue(),
			mode : Ext.Cmp('Mode').getValue(),
...
Ext.DOM.ShowExcel = function(){
	Ext.Window
	({
		url 	: Ext.DOM.INDEX +'/CallCenterReport/ShowExcel/',
		param 	: { 
...
Ext.DOM.AgentByGroup= function( Group )
	Ext.Ajax
	({
		url 	: Ext.DOM.INDEX +'/CallCenterReport/getAgentByGroup/',
		param 	: {
			GroupId : Group.value
		}
	}).load('DivAgent');
...
<div id="panel-main-content">
	<table border=0 width='100%'>
		<tr>
			<td width='40%' valign="top"><?php $this -> load-> view('rpt_call_center/report_call_center_group');?></td>
			<td width='60%' valign="top"><?php $this -> load-> view('rpt_call_center/report_call_center_content');?></td>
		</tr>
	</table>
</div>
</fieldset>
