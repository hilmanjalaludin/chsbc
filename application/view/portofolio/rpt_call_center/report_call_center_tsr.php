...
<table class="grid" cellpadding="0" cellspacing="0" width="90%">
 ...
 <tr>
  <td align="center" rowspan=3 class="header first">Agent</td>
...
// ?>
<tr>
	<td class="header first">&nbsp;<?php __($no);?></td>
	<td class="header middle">&nbsp;<?php __($Agents['name']);?></td>
...
<tr height='22' bgcolor='#eaf6fa'>
	<td class="content-first" colspan=2>&nbsp;<b>Total</b></td>
