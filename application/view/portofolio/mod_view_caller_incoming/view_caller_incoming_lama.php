...
<div id="ui-widget-role-tabs" class="corner">
	...
	<div id="ui-widget-role-tabs" class="ui-widget-user-tabs">
		<div class="ui-widget-awesome-corner">
			...
			<?php echo form()->legend(lang("Incoming Call"),"fa-phone");?>
				<form name="frmCallIncoming">
					...
					<?php echo form()->hidden("callprojectcode", null, $objCall->get_value('callproject'));?> 
					
					<?php echo form()->hidden("save_track_code");?> 
					<!-- table --> 
					<div class="ui-widget-form-table">
						<!--<div class="ui-widget-form-row">
							<div class="ui-widget-form-cell text_caption right"><?php //echo lang('Caller Project')?></div>
							<div class="ui-widget-form-cell text_caption center">:</div>
							<div class="ui-widget-form-cell"><?php //echo form()->combo("caller_project","select superlong x-select", Project(), $objCall->get_value('callproject')); ?></div>
						</div>-->
						...
						<div class="ui-widget-form-row">
							<div class="ui-widget-form-cell text_caption right"><?php echo lang("Customer Address");?></div>
							<div class="ui-widget-form-cell text_caption center">:</div>
							<div class="ui-widget-form-cell"><?php echo form()->textarea("caller_address","textarea superlong uppercase address", $objCaller->get_value('caller_address'), NULL, array("style" => "height:10px;") ); ?></div>
						</div>
						...
						<div class="ui-widget-form-row ui-display-none">
							<div class="ui-widget-form-cell text_caption right"><?php echo lang("Customer Gender");?></div>
							<div class="ui-widget-form-cell text_caption center">:</div>
					...
					<div class="ui-widget-form-table">
						...
						<div class="ui-widget-form-row">
							<div class="ui-widget-form-cell text_caption right"><?php echo lang("Contact Number");?></div>
							<div class="ui-widget-form-cell text_caption center">:</div>
					...
					<div class="ui-widget-form-table">
						...
						<div class="ui-widget-form-row">
							...
							<div class="ui-widget-form-cell text_caption center">:</div>
							<div class="ui-widget-form-cell"><span id="lbl_caller_sub_tracker"><?php echo form()->combo("caller_sub_tracker","select superlong", array()); ?><span></div>
						</div>
					</div>	
					
					<!-- table ajax -->
					<div class="ui-widget-form-table" id="ui-child-form"> </div>
					<!-- table button  -->
					<div class="ui-widget-form-table" >	
						<div class="ui-widget-form-row">
							<div class="ui-widget-form-cell text_caption right" style="width:40px;">&nbsp;</div>
							<div class="ui-widget-form-cell text_caption center" style="width:35px;">&nbsp;</div>
							<div class="ui-widget-form-cell text_caption left"><?php echo form()->button("submit_caller_new","button save", lang("Save"), array("click" => "Ext.DOM.SaveCaller();" ) ); ?></div>
							<div class="ui-widget-form-cell text_caption left"><?php echo form()->button("submit_update_role","button close", lang("Cancel"), array("click" => "Ext.DOM.CancelCaller();" ) ); ?></div>
						</div>
					</div>	
				</form>	
			</fieldset>
