<div style="overflow:auto;margin-top:15px;" class="contact-history">
	<div id="tabs" class="corner" class="history-tabs">
		<ul>
			...
			<li class="ui-tab-li-lasted" id="cdd-tabs"><a href="#tabs-7"><span class="ui-icon ui-icon-person" ></span><?php echo lang('Cdd');?></a></li>
			<li class="ui-tab-li-lasted"><a href="#tabs-3"><span class="ui-icon ui-icon-person"></span><?php echo lang('Product Info');?></a></li>
			<!-- <li class="ui-tab-li-lasted"><a href="#tabs-4"><span class="ui-icon ui-icon-person"></span><?php echo lang('Referral');?></a></li>
			<li class="ui-tab-li-lasted"><a href="#tabs-5"><span class="ui-icon ui-icon-person"></span><?php echo lang('Best Bill');?></a></li> -->
		</ul>
		...
		<div id="tabs-7" style="background-color:#FFFFFF;height:400px;overflow:auto;"></div>
