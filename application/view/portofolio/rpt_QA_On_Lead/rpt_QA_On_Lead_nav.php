...
<script>
	...
	Ext.document(document).ready(function()
	{
		...
		Ext.DOM.ShowReport = function() 
		{
			...
			Ext.Window({
				url 	: Ext.DOM.INDEX +'/QAOnLeadReport/ShowReport/',
				param 	: {
		...
		Ext.DOM.ShowExcel = function()
		{
			Ext.Window
			({
				url 	: Ext.DOM.INDEX +'/QAOnLeadReport/ShowExcel/',
				param 	: { 
					start_date : Ext.Cmp('start_date').getValue(), 
					end_date : Ext.Cmp('end_date').getValue(),
					mode : Ext.Cmp('ModeBy').getValue(),
		...
		Ext.Ajax
		({
			url 	: Ext.DOM.INDEX +'/QAOnLeadReport/getCampaign/',
			param 	: {
...
<fieldset class="corner">
	<legend class="icon-customers">&nbsp;&nbsp;<span id="legend_title">QA Report On Lead </span></legend>
<div id="panel-main-content">
	<table border=0 width='100%'>
		<tr>
			<td width='40%' valign="top"><?php $this -> load-> view('rpt_QA_On_Lead/rpt_QA_On_Lead_filter');?></td>
		</tr>
	</table>
</div>
</fieldset>