...
<?php echo form()->legend(lang(array("Filter","Of", "Report")),"fa-file-text-o");?>
 ...
 <form name="callactivity" class="CallActivity">
	<div class="ui-widget-form-table-compact">		
		...
		<div id="ui-widget-row5" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row5"> <?php echo form()->input('start_date_ca','input_text box startdate date');?> &nbsp - <?php echo form()->input('end_date_ca','input_text box enddate date');?></div>
		</div>
