...
<input type="hidden" class="InputScore_section1<?= $formfor; ?>" name="TotalScoreSec1" value="">
<input type="hidden" class="InputScore_section2<?= $formfor; ?>" name="TotalScoreSec2" value="">
<input type="hidden" class="InputScore_section3<?= $formfor; ?>" name="TotalScoreSec3" value="">
<input type="hidden" class="InputScore_section4<?= $formfor; ?>" name="TotalScoreSec4" value="">
...
<table class="table1">
	...
	<tr>
		<td>Agent ID</td>
		<td><input required="required" class="required_scoring" type="text" name="Agent_ID" value="<?= $Seller->id; ?>">
		<input type="hidden" name="AgentSeller" value="<?= $Seller->UserId; ?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>Acknowledge</td>
		<td class="yellow">
			<select required="required" class="required_scoring" name="Acknowledge">
				<option <?= _selected("",$fs->Acknowledge); ?> value=""> - </option>
				<option <?= _selected("Yes",$fs->Acknowledge); ?> value="Yes">Yes</option>
				<option <?= _selected("No",$fs->Acknowledge); ?> value="No">No</option>
			</select>
		</td>
	</tr>
	<tr>
...
<table class="table1">
	...
	<tr>
		...
		<td class="yellow ">
			<input hidden class="score_result<?= $formfor; ?>" type="text" name="Enter_New_Score" value="<?= $fs->Enter_New_Score; ?>">
			<input type="text" name="TotalScore" value="<?= $fs->TotalScore; ?>">
		</td>
	</tr>
</table>
