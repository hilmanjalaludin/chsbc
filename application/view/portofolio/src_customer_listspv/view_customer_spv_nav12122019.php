...
Ext.DOM.load_Recsource_pull_src = function(obj){
	$("#src_customerspv_recsource").toogle({url:'SrcCustomerListSpv/filtered_recsource', param:{time : Ext.Date().getDuration()}, elval:['src_campaign_name','src_customerspv_keyword']});
};
/*
 * @ package 		detail go customer data 
 */
