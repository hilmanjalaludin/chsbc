...
<?php echo form()->hidden('FlagType_2nd',NULL, $SecondDetail->get_value('flag_type') );?>
	...
	<div class="ui-widget-form-table-compact" style="width:99%;">
		<div class="ui-widget-form-row" style="vertical-align:top;">
			<div class="ui-widget-form-cell ui-widget-content-top">
				<?php $this->load->view('mod_contact_detail_pds/second_product/view_contact_default_detail');?>
				<?php $this->load->view('mod_contact_detail_pds/second_product/view_contact_history_detail');?>
			</div>
			<div class="ui-widget-form-cell" style="vertical-align:top;">
				<?php $this ->load ->view('mod_contact_detail_pds/second_product/view_contact_phone_detail');?>
			</div>
		</div>
	</div>
	<!-- stop : detail -->
