...
// --- load data will loop -------------------
		...
		while(true)
		{
			...
			printf("%s", "<tr>");
					...
					printf("<td class=\"content\" align=\"right\">%s</td> ", ( $agent_ready ? ($agent_ready) : 0));
					printf("<td class=\"content\" align=\"right\">%s</td> ", ( $agent_not_ready ? ($agent_not_ready) : 0) );
					printf("<td class=\"content\" align=\"right\" nowrap>%s</td> ", ( $agent_busy ? ($agent_busy) : 0 ));
					printf("<td class=\"content\" align=\"right\">%s</td>", ( $agent_acw ? ($agent_acw) : 0) ); 
					printf("<td class=\"content\" align=\"right\">%s</td>", ( $agent_logoff ? ($agent_logoff) : 0) );
