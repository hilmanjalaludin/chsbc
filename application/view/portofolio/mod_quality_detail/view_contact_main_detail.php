...
<?php $this ->load ->view('mod_quality_detail/view_contact_javascript');?>

<!-- detail content -->
<fieldset class="corner" style="border-radius:5px;"> 
<?php echo form()->legend(lang('Approval Detail'), "fa-user"); ?>
...
<?php echo form()->hidden('ViewProductInfo',NULL, $Detail->get_value('ViewProductInfo') );?>
	...
	<div class="ui-widget-form-table-compact" style="width:99%;">
		<div class="ui-widget-form-row" style="vertical-align:top;">
			<div class="ui-widget-form-cell" style="width:73%;">
				<?php $this->load->view('mod_quality_detail/view_contact_default_detail');?>
				<?php $this->load->view('mod_quality_detail/view_contact_history_detail');?>
			</div>
			<div class="ui-widget-form-cell" style="vertical-align:top;">
				<?php $this ->load ->view('mod_quality_detail/view_contact_phone_detail');?>
			</div>
		</div>
	</div>
	<!-- stop : detail -->
