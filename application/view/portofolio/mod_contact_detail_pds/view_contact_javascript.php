...
$(document).ready( function() {
	Ext.DOM.PDSCallRunning = 0;
  // console.log('## Automic Dial');
  ...
  $('#ButtonUserCancel').prop('disabled', true);
	...
	if(Ext.Cmp('PDSCall').getValue()==1){
		Ext.DOM.PDSCallRunning = 1;
	}else{
		Ext.DOM.PDSCallRunning = 0;
	}
	
	if(Ext.DOM.PDSCallRunning==1){
		Ext.DOM.initFunc.isCallPhone = true;
		Ext.DOM.initFunc.isCancel = false;
