...
// ----------------------------------------------------------------
 ...
 $(document).ready(function()
 {
	$('#toolbars').extToolbars({
		...
		extTitle :[['Search'],['Clear'],['Detail Data'],['Export'],['Download Template']],
		extMenu  :[['Search'],['Clear'],['ShowRowData'],['ExportExcel'],['DownloadTemplate']],
		extIcon  :[['zoom.png'],['cancel.png'],['table_go.png'],['page_white_excel.png'],['database_table.png']],
		extText  :true,
		extInput :true,
		extOption:[]
	});	
