  	...
  	<script type="text/javascript">
		...
		$(function(){
			$('#toolbars').extToolbars({
				extUrl   :'../gambar/icon',
				extTitle :[['Enable'],['Disable'] ,['Add'],['Edit'],['Delete'],['Add Schedule'],['Cancel']],
				extMenu  :[['FTP_enable'],['FTP_disabled'],['FTP_adding'],['FTP_edit'],['FTP_delete'],['FTP_add_schedule'],['cancelResult']],
				extIcon  :[['accept.png'],['cancel.png'], ['add.png'],['calendar_edit.png'],['delete.png'],['clock_add.png'],['cancel.png']],
				extText  :true,
				extInput :false,
				extOption: [{
						render:6,
