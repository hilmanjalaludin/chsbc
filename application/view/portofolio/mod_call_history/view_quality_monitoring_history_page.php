 ...
 */
 ...
 $arr_header = array
 (
	"CustomerName"=> lang("Customer Name"),
    "CodeUser" => lang("Agent Id"),
    "TotalScore" => lang(array("Score Result")),
    "Privilege"=> lang(array("Privilege")),
    "StatusCallmon" => lang(array("Callmon")) , 
    "DateCallmon" => lang(array("Date Scoring")) 
 ); 
 
  $arr_class = array
 (
    "CustomerName"=> "content-middle",
    "CodeUser" => "content-middle",
    "TotalScore" => "content-middle",
    "Privilege"=> "content-middle",
	"StatusCallmon" => "content-middle",
    "DateCallmon"=> "content-lasted"
 ); 
