...
//---- filter data ---------------------------
 ...
 if( $rs->num_rows() > 0 ) 
	 foreach( $rs->result_assoc() as $rows ) 
{
	$data[$rows['AssignSelerId']]['tot_data_atempt'] +=($rows['status_601']+$rows['status_602']+$rows['status_603']);
...
// ------------------ solicited ----------------------------------------------------	
 ...
 $avg_data_connect_rate  = ( $tot_data_connected_y ? _setPercent( $tot_data_connected_y/$tot_data_atempt): 0 );
