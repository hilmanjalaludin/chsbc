 ...
 function _select_campaign_group_mgr_summary()
{
 ...
 $TmrId = array_keys($cls->_select_report_tmr_by_mgr($ManagerId));
...
// $UI->db->where_in("a.AssignSelerId", array_map('intval', $TmrId ));
 ...
 $UI->db->group_by(array("AssignAmgr", "AssignSelerId"));
...
// =========================================  DIST OLD DB  SUMMARY/ MGR =========================================

 $UI->db->reset_select();
 $UI->db->select("count( distinct a.CustomerId) as tot_re_assigned,a.AssignAmgr as AssignAmgr,
...
// ==================== SOLICITED NEW / MGR  ===================================
 ...
 $arr_utilize_new = null;
  ...
  $UI->db->group_by(array('AssignAmgr','AssignSellerId'));
  ...
  if( $rs->num_rows() > 0 ) 
	foreach( $rs->result_assoc() as $rows ) 
 {
	$arr_utilize_new[$rows['AssignAmgr']][$rows['AssignSellerId']]= explode(',', $rows['arr_utilize_new_id']);
	$data[$rows['AssignAmgr']]['data_new_utilize'] += $rows['tot_utilize_new'];
	$data[$rows['AssignAmgr']]['data_all_solicited'] += $rows['tot_utilize_new'];
 }
...
// ==================== SOLICITED OLD / MGR  ===================================
	...
	$UI->db->group_by(array("AssignAmgr", "AgentId","CustomerId"));
	...
	if( $rs->num_rows() > 0 ) 
		foreach( $rs->result_assoc() as $rows ) 
	{
		$arr_skip_data = $arr_utilize_new[$rows['AssignAmgr']][$rows['AgentId']];
		if( !in_array($rows['CustomerId'], $arr_skip_data)) {
			$data[$rows['AssignAmgr']]['data_old_utilize'] += $rows['tot_old_utilize'];
			$data[$rows['AssignAmgr']]['data_all_solicited'] += $rows['tot_old_utilize'];
		}
	}
...
// $UI->db->print_out();
	...
	foreach( $rs->result_assoc() as $rows ) 
 {
	...
	$data[$rows['AssignAmgr']]['tot_data_status_000']+=$rows['status_000'];
	$data[$rows['AssignAmgr']]['tot_data_status_101']+=$rows['status_101'];
	$data[$rows['AssignAmgr']]['tot_data_status_102']+=$rows['status_102'];
	$data[$rows['AssignAmgr']]['tot_data_status_103']+=$rows['status_103'];
	$data[$rows['AssignAmgr']]['tot_data_status_201']+=$rows['status_201'];
	$data[$rows['AssignAmgr']]['tot_data_status_202']+=$rows['status_202'];
	$data[$rows['AssignAmgr']]['tot_data_status_203']+=$rows['status_203'];
	$data[$rows['AssignAmgr']]['tot_data_status_204']+=$rows['status_204'];
	$data[$rows['AssignAmgr']]['tot_data_status_205']+=$rows['status_205'];
	$data[$rows['AssignAmgr']]['tot_data_status_206']+=$rows['status_206'];
	$data[$rows['AssignAmgr']]['tot_data_status_207']+=$rows['status_207'];
	$data[$rows['AssignAmgr']]['tot_data_status_208']+=$rows['status_208'];
	$data[$rows['AssignAmgr']]['tot_data_status_209']+=$rows['status_209'];
	$data[$rows['AssignAmgr']]['tot_data_status_210']+=$rows['status_210'];
	$data[$rows['AssignAmgr']]['tot_data_status_211']+=$rows['status_211'];
	$data[$rows['AssignAmgr']]['tot_data_status_301']+=$rows['status_301'];
	$data[$rows['AssignAmgr']]['tot_data_status_302']+=$rows['status_302'];
	$data[$rows['AssignAmgr']]['tot_data_status_303']+=$rows['status_303'];
	$data[$rows['AssignAmgr']]['tot_data_status_304']+=$rows['status_304'];
	$data[$rows['AssignAmgr']]['tot_data_status_305']+=$rows['status_305'];
	$data[$rows['AssignAmgr']]['tot_data_status_306']+=$rows['status_306'];
	$data[$rows['AssignAmgr']]['tot_data_status_307']+=$rows['status_307'];
	$data[$rows['AssignAmgr']]['tot_data_status_308']+=$rows['status_308'];
	$data[$rows['AssignAmgr']]['tot_data_status_309']+=$rows['status_309'];
	$data[$rows['AssignAmgr']]['tot_data_status_310']+=$rows['status_310'];
	$data[$rows['AssignAmgr']]['tot_data_status_311']+=$rows['status_311'];
	$data[$rows['AssignAmgr']]['tot_data_status_312']+=$rows['status_312'];
	$data[$rows['AssignAmgr']]['tot_data_status_313']+=$rows['status_313'];
	$data[$rows['AssignAmgr']]['tot_data_status_314']+=$rows['status_314'];
	$data[$rows['AssignAmgr']]['tot_data_status_315']+=$rows['status_315'];
	$data[$rows['AssignAmgr']]['tot_data_status_316']+=$rows['status_316'];
	$data[$rows['AssignAmgr']]['tot_data_status_317']+=$rows['status_317'];
	$data[$rows['AssignAmgr']]['tot_data_status_701']+=$rows['status_701'];
	$data[$rows['AssignAmgr']]['tot_data_status_401']+=$rows['status_401'];
	$data[$rows['AssignAmgr']]['tot_data_status_402']+=$rows['status_402'];
	$data[$rows['AssignAmgr']]['tot_data_status_319']+=$rows['status_319'];
 }
 
 
 
// ================ GET DATA ATEMPT PER ATM SUMMARY 2=======================================
 ...
 $rs = $UI->db->get();
  if( $rs->num_rows() > 0 ) 
	foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignAmgr']]['tot_data_atempt'] +=$rows['status_601'];
	$data[$rows['AssignAmgr']]['tot_data_atempt'] +=$rows['status_602'];
	$data[$rows['AssignAmgr']]['tot_data_atempt'] +=$rows['status_603'];
	
	$data[$rows['AssignAmgr']]['tot_data_status_601']+=$rows['status_601'];
	$data[$rows['AssignAmgr']]['tot_data_status_602']+=$rows['status_602'];
	$data[$rows['AssignAmgr']]['tot_data_status_603']+=$rows['status_603'];
 }
...
// --------- atempt  ----------------------
 ...
 $tot_data_atempt =$tot_connected_call;// ( $row['tot_data_atempt'] ? $row['tot_data_atempt'] : 0 );
 ...
 function _select_campaign_group_per_mgr_detail( $ManagerId =0 )
{
 ...
 $AtmId = array_keys($cls->_select_report_atm_by_manager($ManagerId));
 $SpvId  = array_keys($cls->_select_report_spv_by_mgr($ManagerId));
...
// ============================== DIS NEW DB  ==============================
 ...
 $UI->db->group_by(array("AssignSpv", "AssignLeader", "AssignSelerId"));
 $rs = $UI->db->get();
...
// ===================== OLD DIS DATA ==============================================
 ...
 $UI->db->select("
	...
	a.AssignSpv as AssignSpv, a.AssignSelerId as AssignSelerId", FALSE);
...
// ==================== SOLICITED NEW / ATM / MGR  ===================================
  ...
  $UI->db->where_in("a.AMGRID", array_map('intval', array($ManagerId)));
  $UI->db->where_in("a.ATMID", array_map('intval',  $AtmId ));
  $UI->db->where_in("a.SPVID", array_map('intval',  $SpvId ));
  $UI->db->where_in("a.AgentId", array_map('intval', $TmrId ));
  $UI->db->where("a.SessionReport", $gReportSession);
  $UI->db->group_by(array('AssignSpv','AssignLeader', 'AssignSellerId'));
  ...
  if( $rs->num_rows() > 0 ) 
	foreach( $rs->result_assoc() as $rows ) 
 {
	$arr_utilize_new[$rows['AssignSpv']][$rows['AssignLeader']][$rows['AssignSellerId']] = explode(',', $rows['arr_utilize_new_id']);
...
// ==================== SOLICITED OLD /ATM/MGR  ===================================
	...
	$UI->db->where_in("e.UserId", array_map('intval', array($ManagerId)));
 	$UI->db->group_by(array("AssignSpv", "AgentId","CustomerId"));
	...
	if( $rs->num_rows() > 0 ) 
		foreach( $rs->result_assoc() as $rows ) 
	{
		$arr_skip_data = $arr_utilize_new[$rows['AssignSpv']][$rows['AssignLeader']][$rows['AgentId']];
		if( !in_array($rows['CustomerId'], $arr_skip_data)) {
...
// ================ GET DATA ATEMPT PER ATM SUMMARY 1=======================================
 ...
 $rs = $UI->db->get();
  if( $rs->num_rows() > 0 ) 
	foreach( $rs->result_assoc() as $rows ) 
 {
	$data[$rows['AssignSpv']]['tot_data_atempt'] += ($rows['status_601']+$rows['status_602']+$rows['status_603']);
