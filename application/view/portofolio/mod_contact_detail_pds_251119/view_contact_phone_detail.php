 ...
 <?php echo form()->hidden("CallingNumber",NULL, $Detail->get_value('CustomerMobilePhoneNum')); ?>
	...
	<div class="ui-widget-form-table-compact">
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell"><?php echo form()->combo('PhoneNumber','select tolong select-chosen ui-data-disabled', CustomerContactPhone($Detail->get_value('CustomerId')), $Detail->get_value('CustomerMobilePhoneNum'),array("change" =>"Ext.Cmp('CallingNumber').setValue(this.value);Ext.Cmp('AddPhoneNumber').setValue('');") ); ?></div>
		</div>
