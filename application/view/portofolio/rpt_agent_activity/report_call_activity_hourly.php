...
<tr height='22' bgcolor='<?php __($color); ?>'>
	...
	<td class="content-middle left">&nbsp;<?php __($rows['Username']);?></td>
	<td class="content-middle right">&nbsp;<?php __($rows['tots']);?></td>
	<td class="content-middle right">&nbsp;<?php __($rows['tot_connected']);?></td>
	<td class="content-middle right">&nbsp;<?php __($rows['tot_abandone']);?></td>
