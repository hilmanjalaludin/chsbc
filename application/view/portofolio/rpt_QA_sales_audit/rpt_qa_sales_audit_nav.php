...
<script>
	Ext.DOM.ListAtm=function()
	{
		Ext.Ajax
		({
			url 	: Ext.DOM.INDEX +'/QASalesAuditReport/GroupFilterBy/',
			param 	: {
	...
	Ext.DOM.ListTL=function()
	{
		Ext.Ajax
		({
			url 	: Ext.DOM.INDEX +'/QASalesAuditReport/GroupFilterTL/',
			param 	: {
	...
	Ext.DOM.ListTSR=function()
	{
		Ext.Ajax
		({
			url		: Ext.DOM.INDEX +'/QASalesAuditReport/GroupFilterTSR/',
			param	: {
	...
	Ext.DOM.ShowReport=function()
	{
		...
		else
		{
			...
			(
				{
					url 	: Ext.DOM.INDEX +'/QASalesAuditReport/ShowReport/',
					param	: 	{
	...
	Ext.DOM.ShowExcel = function()
	{
		Ext.Window
		({
			url 	: Ext.DOM.INDEX +'/QASalesAuditReport/ShowExcel/',
			param 	: { 
				filter_by : Ext.Cmp('FilterBy').getValue(),
				spv_id : Ext.Cmp('spvname').getValue(),
				tl_id : Ext.Cmp('tlname').getValue(),
