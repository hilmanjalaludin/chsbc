...
/* 
	...
	'Flags' => 'left'
 */
 page_set_align('CallReasonCode', 'center');
 page_set_align('CallReasonDesc', 'left');
 page_set_align('CallStatus', 'left');
 page_set_align('CallReasonEvent', 'center');
 page_set_align('CallReasonLater', 'center');
 page_set_align('CallReasonNoNeed', 'center');
 page_set_align('CallReasonOrder', 'center');
 page_set_align('Flags', 'center');
...
echo " <table width=\"100%\" class=\"custom-grid\" cellspacing=\"0\">".
	...
	"<tr height=\"26\"> ".
		...
		if( is_array($labels) )
			...
			echo "<th nowrap class=\"font-standars ui-corner-top ui-state-default th-$border[$Field] $border[$Field] center\" $arr_width[$Field]>".
...
// --------------- on content -----------------------
$_new = explode(',',_getConfigValue('CALL_REASON','REASON_NEW'));
