...
Ext.DOM.ShowDashboard = function()
{
	...
	// {
		...
		Ext.Ajax  
		({
			url    : Ext.DOM.INDEX+"/DailyNewDashboard/ShowDashboard/",
			method : 'POST',
			param  : Ext.Join([
...
<div class="ui-widget-form-table-compact" style="width:99%;">
	<!-- d i v class="ui-widget-form-row">
	...
	<div class="ui-widget-form-row">
		...
		<?php echo form()->legend(lang("Home"),"fa-bars");?>
			...
			<div class="ui-widget-form-cell left" style="vertical-align:top;">
				<?php echo form()->button('dsb_button_data','button search',"Refresh", array("click" => "new ShowDashboard();"),array('style'=>'margin:0px;'));?>
			</div>
