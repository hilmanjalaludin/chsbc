...
<div class="ui-widget-form-table-compact">
	<div class="ui-widget-form-row">
		...
		<div class="ui-widget-form-cell"> <?php echo form()->combo('ProductSimulate', 'select superlong select-chosen', CustomerProductId( $Customers->get_value('CustomerId')), NULL, array('change' => 'Ext.DOM.ProdPreview(this.value);'));?> </div>
	</div>
</div>
