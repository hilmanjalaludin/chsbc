...
<table name="section1" class="scoring">
	...
	<tbody>
		...
		<tr>
			...
			<td class="center">
				<select required="required" triggerto="section4_2_val<?= $formfor; ?>" name="Section4_2" class="section4<?= $formfor; ?>">
					<option value=""   valuejs="0">- choose one -</option>
		...
		<tr>
			...
			<td class="center totalscore_section4<?= $formfor; ?> totalsection<?= $formfor; ?>">0</td>
		</tr>
	</tbody>
</table>