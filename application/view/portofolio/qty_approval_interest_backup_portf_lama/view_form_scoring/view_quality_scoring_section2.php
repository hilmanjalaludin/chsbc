...
<table name="section2" class="scoring">
	...
	<tbody>
		<tr rowspan="2">
			...
			<td class="center">
				<select required="required" triggerto="section2_1_val<?= $formfor; ?>" name="Section2_1" class="section2<?= $formfor; ?>">
					...
					<option <?= _selected("Below Standard",$SSection1->Section2_1); ?> value="Below Standard" valuejs="0">Below Standard</option>
				</select>	
			</td>
		...
		<tr>
			...
			<td class="center">
				<select required="required" triggerto="section2_2_val<?= $formfor; ?>" name="Section2_2" class="section2<?= $formfor; ?>">
					<option value=""   valuejs="0">- choose one -</option>
					...
					<option <?= _selected("Below Standard",$SSection1->Section2_2); ?> value="Below Standard" valuejs="0">Below Standard</option>
				</select>	
			</td>
		...
		<tr>
			...
			<td class="center">
				<select required="required" triggerto="section2_3_val<?= $formfor; ?>" name="Section2_3" class="section2<?= $formfor; ?>">
					<option value=""   valuejs="0">- choose one -</option>
					...
					<option <?= _selected("Below Standard",$SSection1->Section2_3); ?> value="Below Standard" valuejs="0">Below Standard</option>
				</select>
			</td>
		...
		<tr>
			...
			<td class="center totalscore_section2<?= $formfor; ?> totalsection<?= $formfor; ?>">0</td>
		</tr>
	</tbody>
</table>