...
<?php echo form()->legend(lang("Filter Transfer"),"fa-search");?>
	<div class="ui-widget-form-table" style="margin-top:-5px;">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("trans_call_status_id", "select  tolong", OutboundCategory(),null,array('change'=>'Ext.DOM.CallStatCheck2(this)'));?></div>
		</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("trans_call_result_id", "select  tolong", CallResultNotInterest());?></div>
		</div>
