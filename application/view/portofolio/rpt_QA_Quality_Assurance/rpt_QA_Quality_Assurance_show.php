...
<table class="grid" cellpadding="0" cellspacing="0" width="100%" bgcolor="red">
	<tr>
		<td colspan=13 class="sub first">Actual</td>
	</tr>
	<?php
		if(is_array($view_atm)) foreach ($view_atm as $AtmId => $atm) :
	?>
	<tr>
		<td colspan=13 class="atm first">ATM: <?php echo $atm['ATM']; ?></td>
	</tr>
		<?php
			if(is_array($view_spv)) foreach ($view_spv as $SpvId => $rows) :
		?>
	<tr>
		<td colspan=13 class="agent first">Supervisor: <?php echo $rows['SPV']; ?></td>
	</tr>
	<tr>
		...
		<td rowspan=2 class="header middle" align="center">Total Fatal</td>
		<td rowspan=2 class="header middle" align="center">Fatal Error Rate</td>
		<td rowspan=2 class="header middle" align="center">Average QA Score</td>
		<td colspan=5 class="header lasted" align="center">Questions Category</td>
	</tr>
	<tr>
		<td class="header middle" align="center">Basic Telephone Manner</td>
		<td class="header middle" align="center">Sales Presentation</td>
		<td class="header middle" align="center">Knowledge on Product & Procedure</td>
		<td class="header middle" align="center">Objection Handling</td>
		<td class="header lasted" align="center">Sales confirmation</td>
	</tr>
			<?php
				$PassingRate = 0;
				$FatalRate = 0;
			...
			?>
	<tr>
		<td colspan=2 class="header first"><?php echo $agent['Agent']; ?></td>
		<td class="content first" align="right"><?php echo $Monitor; ?></td>
		<td class="content middle" align="right"><?php echo $Pass; ?></td>
		<td class="content middle" align="right"><?php echo round($PassingRate,2); ?> %</td>
		<td class="content middle" align="right"><?php echo $TotalFatal; ?></td>
		<td class="content middle" align="right"><?php echo round($FatalRate,2); ?> %</td>
		<td class="content middle" align="right"><?php echo round($AvgQA,2); ?> %</td>
		<td class="content middle" align="right"><?php echo $Basic; ?></td>
		<td class="content middle" align="right"><?php echo $Presentation; ?></td>
		<td class="content middle" align="right"><?php echo $Knowledge; ?></td>
		<td class="content middle" align="right"><?php echo $Handling; ?></td>
		<td class="content lasted" align="right"><?php echo $Confirmation; ?></td>
	</tr>
			<?php
	...
	<tr>
		...
		<td class="total middle" align="right"><?php echo number_format($sMonitor); ?></td>
		<td class="total middle" align="right"><?php echo number_format($sPass); ?></td>
		<td class="total middle" align="right"><?php echo round($sPassingRate,2); ?> %</td>
		<td class="total middle" align="right"><?php echo number_format($sTotalFatal); ?></td>
		<td class="total middle" align="right"><?php echo round($sFatalRate,2); ?> %</td>
		<td class="total middle" align="right"><?php echo round($sAvgQA,2); ?> %</td>
		<td class="total middle" align="right"><?php echo number_format($sBasic); ?></td>
		<td class="total middle" align="right"><?php echo number_format($sPresentation); ?></td>
		<td class="total middle" align="right"><?php echo number_format($sKnowledge); ?></td>
		<td class="total middle" align="right"><?php echo number_format($sHandling); ?></td>
		<td class="total lasted" align="right"><?php echo number_format($sConfirmation); ?></td>
	</tr>
		<?php
			endforeach;
		?>
