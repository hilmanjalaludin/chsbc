...
<body>
 <div id="wrapper">
	...
	<div class="ui-bottom-widget-navigation-bars" > <?php $this->load->layout(base_layout().'/UserToolbars'); ?></div>
	<div class="ui-bottom-cti-bottom"><?php $this->load->layout(base_layout().'/UserCti');?></div>
