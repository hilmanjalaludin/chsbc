...
<link type="text/css" rel="stylesheet" href="<?php echo base_datatables();?>/dataTables.jqueryui.min.css?time=<?php echo time();?>" />
...
<script type="text/javascript" src="<?php echo base_datatables();?>/jquery.dataTables.js?version=<?php echo version();?>&amp;time=<?php echo time();?>"></script> 
<script type="text/javascript" src="<?php echo base_datatables();?>/jquery.dataTables.js?version=<?php echo version();?>&amp;time=<?php echo time();?>"></script> 
