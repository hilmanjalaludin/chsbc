	...
	<fieldset class="corner" style="margin-bottom:15px;">
		...
		<div class="ui-widget-form-table-compact">
			...
			<div class="ui-widget-form-row baris-1">
				...
				?>
				<div class="ui-widget-form-cell left">
					<?php echo form() -> hidden('c_cycle_due_date',null, 2);?>
			...
			<!--INPUT CREDIT LIMIT-->
			<div class="ui-widget-form-row baris-1">
				<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Old Instalment'));?></div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				<?php
				...
				?>
				<div class="ui-widget-form-cell left">
					<?php echo form() -> hidden('c_old_instalment',null, 1);?>
			...
			<!--INPUT ACOUNT-->
			<div class="ui-widget-form-row baris-1">
				<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Acount'));?></div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				<?php
				...
				?>
				<div class="ui-widget-form-cell left">
					<?php echo form() -> hidden('c_account',null, 1);?>
