				...
				Ext.Util(fn).proc(function(save){
					...
					save.map(function(save, index, arr) {
						...
						if (indarr == 0) {
							...
							$('#additional_cc_2nd').prop('disabled', true);
							$('#limit_cc_2nd').prop('disabled', true);
							$('#expiry_date_2nd').prop('disabled', false);
							$('#no_telp_2nd').prop('disabled', true);
							$('#total_jenis_cc_2nd').prop('disabled', true);
							$('#jenis_cc_2nd').prop('disabled', true);
							$('#jatuh_tempo_2nd').prop('disabled', true);
							...
							$('#limit_cc_2nd').prop('disabled', true);
							$('#expiry_date_2nd').prop('disabled', true);
							$('#no_telp_2nd').prop('disabled', false);
							$('#total_jenis_cc_2nd').prop('disabled', true);
							$('#jenis_cc_2nd').prop('disabled', true);
							$('#jatuh_tempo_2nd').prop('disabled', true);
						} else if (indarr == 4) {
...
Ext.DOM.CheckAsk_1_2nd = function(id) {
	...
	if(additional_cc=="" || additional_cc==null){
		alert('Additional CCs Field is Empty!');
		readycheck = 0;
		return false;
	} else {
		if (additional_cc == 1) {
			...
			ERROR  : function(fn)
			{
				Ext.Util(fn).proc(function(save){
					...
					if (save.conds == true) {
						...
						$('#default_2nd_2nd').hide();
						$('#rejected_2nd_2nd').show();
						$('#expiry_date_2nd').prop('disabled', true);
						$('#ask_2_button_2nd').prop('disabled', false);
						$('#CallStatus_2nd').val(4);
						$('#CallResult_2nd').append("<option value='9'>Reject Verification</option>");
						$('#CallResult_2nd').val(9);
						$('#CallStatus_2nd').prop('disabled', true).trigger("chosen:updated");
...
Ext.DOM.CheckAsk_3_2nd = function(id) {
	var val = Ext.Cmp('expiry_date_2nd').getValue();
	var readycheck = 0;
		...
		({
			...
			ERROR  : function(fn)
			{
				Ext.Util(fn).proc(function(save){
					...
					if (save.conds == true) {
						//edit rangga homenumber&phonenumber
...
Ext.DOM.CheckAsk_4_2nd = function(id) {
	var val = Ext.Cmp('no_telp_2nd').getValue();
	var readycheck = 0;
		...
		<div class="ui-widget-form-table-compact">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					...
					<input type="text" name="total_additional_cc_2nd" class="input_text long numeric" id="total_additional_cc_2nd" style="padding-left:10px;width:60px;" placeholder="" hidden>
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob_2nd" 
						class="btn btn-success btn-sm" id="ask_1_button_2nd" onclick="Ext.DOM.CheckAsk_1_2nd('ask_1');" 
					title="Verify">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob_2nd" 
						class="btn btn-success btn-sm" id="ask_2_button_2nd" onclick="Ext.DOM.CheckAsk_2_2nd('ask_2');" title="Verify">
							<i class="fa fa-check-square-o"></i>
					</a>
				</div>
				<div id="r_cust_dob_2nd" class="ui-widget-form-cell left">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left">
					<input type="text" name="expiry_date_2nd" id="expiry_date_2nd" class="input_text long" placeholder="__/__">
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob_2nd" 
						class="btn btn-success btn-sm" id="ask_3_button_2nd" onclick="Ext.DOM.CheckAsk_3_2nd('ask_3');" title="Verify">
							<i class="fa fa-check-square-o"></i>
					</a>
				</div>
				<div id="r_cust_dob_2nd" class="ui-widget-form-cell left">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left">
					<input type="text" name="total_jenis_cc_2nd" id="total_jenis_cc_2nd" class="input_text long" placeholder="" style="width:100px">
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob_2nd" 
						class="btn btn-success btn-sm" id="ask_5_button_2nd" onclick="Ext.DOM.CheckAsk_5_2nd('ask_5');" title="Verify">
							<i class="fa fa-check-square-o"></i>
					</a>
				</div>
				<div id="r_cust_dob_2nd" class="ui-widget-form-cell left">
					<b style="color:green;" id="ask_5_success_2nd" hidden><i class="fa fa-check"></i></b>
					<b style="color:red;" id="ask_5_failed_2nd" hidden><i class="fa fa-close"></i></b>
					<b style="color:blue;" id="ask_5_default_2nd"><i class="fa fa-minus" aria-hidden="true"></i></b>
				</div>
			</div>
