                        ...
                        if(strtolower($fields) == 'tenor'){
                            ...
                            if(strtolower($fields) == 'rate'){
                                ...
                                if($row->get_value('Param') == 'QA'){
                                    $data =$row->get_value($fields,$arr_function[$fields]);
                                    $numbers = number_format($data,2,'.',',');
                                }else{
                                $ds = $row->get_value($fields,$arr_function[$fields]);
                                $numbers = number_format($ds,2,'.',',');
                                // $numbers = ;
                                //var_dump($ds);
                               }
                            }
                                ...
                                if($row->get_value('Param') == 'QA'){
                                    $testqa =$row->get_value($fields,$arr_function[$fields]);
                                    $numbers = number_format($testqa,2,'.',',');
                                ...
                                $tenor= $row->get_value($fields,$arr_function[$fields]);
                                $numbers = number_format( $lm + $lm  , 0, '.', ',');
                            }
                            else if(strtolower($fields) == 'installment'){
                                //var_dump('tenor',$TR);
                                 if($row->get_value('Param') == 'QA'){
                                    $instqa =$row->get_value($fields,$arr_function[$fields]);
                                    $numbers = number_format($instqa , 2, '.', ',');
                                    //var_dump('nambur',$numbers);
                                }else{
