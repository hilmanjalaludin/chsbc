<script>
	...
	Ext.DOM.openCoverage = function (val){
		...
		if(Coverage == 1){ // MAIN & FAMILY
			...
			Ext.DOM.setDisabledMain('main',false);
	...
	// var isVerif = Ext.DOM.getVerificationStatus();
		...
		var premi = Ext.Cmp('monthly_premium').getValue();
		if(!Ext.DOM.Validation()){
			return false;
		}else if(premi=="" || isNaN(premi)){
			alert('Total Premi is not valid!');
		}else{
			Ext.Ajax({
	...
	Ext.DOM.Validation = function (){
		var Coverage = Ext.Cmp('coverage').getValue();
		if(Coverage == 1){ // MAIN & FAMILY
			if(Ext.Cmp('name_main').getValue() == "" || Ext.Cmp('age_main').getValue() == "" || Ext.Cmp('sex_main').getValue() == "" || Ext.Cmp('dob_main').getValue()==""){
				alert('Please Compelete Main Insured Data!');
				return false;
			}else{
				if(Ext.Cmp('name_spouse').getValue() == "" || Ext.Cmp('age_spouse').getValue() == "" || Ext.Cmp('sex_spouse').getValue() == "" || Ext.Cmp('dob_spouse').getValue()==""){
					alert('Please Compelete Spouse Data!');
					return false;
				}else{
					return true;
				}
	...
	Ext.DOM.setDisabledMain = function(id,flag)
	{
		// Ext.Cmp('name_'+id).disabled(flag);
		// Ext.Cmp('sex_'+id).disabled(flag);
		Ext.Cmp('dob_'+id).disabled(flag);
...
<?php
	...
	$r_dob_main  = (isset($result['dob_main'])&&$result['dob_main']!='0000-00-00'?date('d-m-Y',strtotime($result['dob_main'])):null);
	/* END OF MAIN */
...
<fieldset class="corner" style="margin-bottom:15px;">
	...
	<div class="ui-widget-form-table" style="margin-top:-5px;">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->input("name_spouse", "input_text  tolong",$r_name_spouse);?></div>
		</div>
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Sex");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->input("name_c2", "input_text  tolong",$r_name_c2);?></div>
		</div>
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Sex");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell bottom">
				...
				<?php echo form()->hidden("age_c2","input_text", null);?>
			</div>
		</div>
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" >
				...
				<?php echo form()->input("monthly_premium-2", "input_text tolong",null,null,array('disabled'=>true));?>
			</div>
		</div>
	</div>
	...
	<div class="ui-widget-form-table" style="margin-top:-5px;">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->input("name_c3", "input_text  tolong",$r_name_c3);?></div>
		</div>
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Sex");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" align="Right">
				...
				<?php if(_get_session('HandlingType')==4){
					echo form()->button("ButtonUserSave", "button save", lang('Save Prod. Info'), array('click' => 'Ext.DOM.saveProductInfo();'));
				}?>
			</div>
		</div>
		<?php
