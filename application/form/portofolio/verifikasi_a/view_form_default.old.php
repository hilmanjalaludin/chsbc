	...
	if(readycheck==1){
		...
		({
			...
			success  : function( xhr ) {
				Ext.Util( xhr ).proc(function(save){
					Ext.DOM.LoadVerification();
				});
			}
		}).post();
...
<form name="frm_verification">
	...
	<fieldset class="corner" style="margin-bottom:15px;padding:10px 0px 20px 0px ">
		<?php echo form()->legend(lang(array('Address','Verification')), "fa-tasks"); ?>
		<div class="ui-widget-form-table-compact">
			<!--Input verif address-->
			<div class="ui-widget-form-row baris-1">
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Is The Address Correct With This ?'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<?php if( $_v_res == 1 and $campaign['CampaignId'] == 9) : 
				
					printf("<div class=\"ui-widget-form-table-compact\">
						<div class=\"ui-widget-form-row\"> 	
							<div class=\"ui-widget-form-cell ui-widget-content-top input_text table-white-space-ys-wrap\">%s</div>
							<div class=\"ui-widget-form-cell ui-widget-content-top\">&nbsp;&nbsp;</div>
							<div class=\"ui-widget-form-cell ui-widget-content-top\">%s</div>
						</div> ", 
							wordwrap($alamatVerif['alamat'], 50, "<br>"),
							form()->combo("addressVerif", "select tolong", $inputAddress, $datas['AddressVerif']) );
