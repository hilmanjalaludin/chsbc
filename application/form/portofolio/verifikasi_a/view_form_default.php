...
Ext.DOM.CheckAsk_2 = function(id) {
	var statement = Ext.Cmp('statement').getValue();
	var email = Ext.Cmp('email').getValue();
	var readycheck = 0;
...
Ext.DOM.CheckAsk_4 = function(id) {
	var total_jenis_cc = Ext.Cmp('total_jenis_cc').getValue();
	var jenis_cc = Ext.Cmp('jenis_cc').getValue();
	var readycheck = 0;
	...
	<fieldset class="corner" style="margin-bottom:15px;">
		...
		<div class="ui-widget-form-table-compact">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob" 
						class="btn btn-success btn-sm" id="ask_1_button" onclick="Ext.DOM.CheckAsk_1('ask_1');" title="Verify">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left">
					<?php echo form() -> combo('statement','select long', array('Yes'=>'YES','No'=>'NO'), $v_i_additional_cc, array("change"=>"showEmail()"), (isset($result['ver_result'])?array('disabled'=>true):$x_i_additional_cc) );?>
					<input type="text" name="email" class="input_text long " id="email" style="padding-left:10px;width:160px;" placeholder="" hidden>
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob" 
						class="btn btn-success btn-sm" id="ask_2_button" onclick="Ext.DOM.CheckAsk_2('ask_2');" 
					title="Verify">
							<i class="fa fa-check-square-o"></i>
					</a>
				</div>
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					...
					<input type="text" name="total_additional_cc" class="input_text long " id="total_additional_cc" style="padding-left:10px;width:160px;" placeholder="" hidden>
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob" 
						class="btn btn-success btn-sm" id="ask_3_button" onclick="Ext.DOM.CheckAsk_3('ask_3');" 
					title="Verify">
							<i class="fa fa-check-square-o"></i>
					</a>
				</div>
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left">
					<input type="text" name="total_jenis_cc" id="total_jenis_cc" class="input_text long" placeholder="" style="width:100px" onchange="showtotalJJ()">
					<?php echo form() -> combo('jenis_cc','select long', array('1'=>'Classic Card','2'=>'Gold Card', '3'=>'Cashback Card', '4'=>'Platinum Card', '5'=>'Signature Card', '6'=>'Premier Card'), $v_i_jenis_cc);?>
				</div>
				<div class="ui-widget-form-cell left">
					<a id="b_cust_dob" 
						class="btn btn-success btn-sm" id="ask_4_button" onclick="Ext.DOM.CheckAsk_4('ask_4');" title="Verify">
