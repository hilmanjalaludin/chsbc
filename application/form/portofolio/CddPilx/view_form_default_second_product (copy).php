...
function copyAlamatIfYes(Flag=null){
	if(Flag){
		alert('Alamat Sama');
	}else{
		alert('Alamat Beda');
...
Ext.DOM.showTotalAcc2_2nd = function() {
	...
	console.log('asd', Ext.Cmp('add2_2nd').getValue())
}
	...
	<fieldset class="corner" style="margin-bottom:15px;" >
		...
		<div class="ui-widget-form-table-compact">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<?php echo form() -> combo('add2_2nd','select long', array('1'=>'YES','0'=>'NO'), $v_i_additional_cc, null, (isset($result['ver_result'])?array('disabled'=>true):$x_i_additional_cc) );?>
					<br>
				</div>
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left">
                <input type="text" name="date_addr_2nd" id="date_addr_2nd" class="input_text long" value="" placeholder="__-__-____" onchange="Test()">
				</div>
			</div>
            ...
            <div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<?php echo form() -> combo('pajak_2nd','select long', array('Ya'=>'Ya','Tidak'=>'Tidak'), $v_i_additional_cc, array("change"=>"showPajak()"), (isset($result['ver_result'])?array('disabled'=>true):$x_i_additional_cc) );?>
				</div>
            </div>
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<?php echo form() -> combo('q6_2nd','select long chosen-container chosen-container-single', array('Gaji'=>'Gaji','Hasil Usaha'=>'Hasil Usaha','Dana Pensiun'=>'Dana Pensiun','Lainnya'=>'Lainnya'), $v_i_additional_cc, array("change"=>"showSumber()"), (isset($result['ver_result'])?array('disabled'=>true):$x_i_additional_cc) );?>
				</div>
        ...
        <div class="ui-widget-form-row baris-1">
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell left">
					<?php echo form() -> combo('p_alamat_2nd','select long chosen-container chosen-container-single', array('1'=>'Ya','0'=>'Tidak'), $v_i_additional_cc, array("change"=>"showAlamatKantor()"), (isset($result['ver_result'])?array('disabled'=>true):$x_i_additional_cc) );?>
				</div>
