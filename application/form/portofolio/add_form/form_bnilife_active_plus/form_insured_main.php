...
<fieldset class="corner" style="margin:5px 5px 10px -5px; padding:5px 8px 15px 8px;border-radius:5px;">
	...
	<div class="ui-widget-form-table">	
		...
		<div class="ui-widget-form-row">	
			...
			<div class="ui-widget-form-cell left"><?php echo form()->input(join("_", array("InsuredDOB",$prefixkey)),"input_text long $selector insured-dob",$outputs->get_value('InsuredDOB'),null,array('disabled'=>true));?></div>
		</div>
