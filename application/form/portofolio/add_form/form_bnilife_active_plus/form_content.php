...
<div id="result_content_add" style='border:1px solid #dddddd;'>
	<ul>
		<li class="ui-tab-li-none"><a href="#tabs-1">
			<span class="ui-icon ui-icon-person"></span><?php echo lang("PAYER AND ADDRESS INFO");?></a></li>
		
		<li class="ui-tab-li-none"><a href="#tabs-2">
			<span class="ui-icon ui-icon-pencil"></span><?php echo lang("INSURED");?></a></li>
			
		<li class="ui-tab-li-none"><a href="#tabs-3">
			<span class="ui-icon ui-icon-pencil"></span><?php echo lang("PLAN");?></a></li>
		
		<li class="ui-tab-li-none"><a href="#tabs-4">
			<span class="ui-icon ui-icon-pencil"></span><?php echo lang("UNDERWRITING");?></a></li>
	
		<li class="ui-tab-li-lasted"><a href="#tabs-5">
			<span class="ui-icon ui-icon-pencil"></span><?php echo lang("BENEFICIARY");?></a></li>
	...
	<div id="tabs-3" class='box-content-data' style="background-color:#FFFFFF;">
