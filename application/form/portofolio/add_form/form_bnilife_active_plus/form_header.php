...
<html>
<head>
<title> <?php echo description(); ?> :: Product Bni Active Plus </title> 
...
<script type="text/javascript" src="<?php echo base_ext_form();  ?>/ProductBniLifeActivePlus.js?version=<?php echo version();?>&&amp;time=<?php echo time();?>"></script>
</head>
<body>
<!-- stop : header data -->