...
<html>
<head>
<title> <?php echo description(); ?> :: Add Product Bni Active </title> 
...
<script type="text/javascript" src="<?php echo base_ext_form();  ?>/ProductBniLifeActive.js?version=<?php echo version();?>&&amp;time=<?php echo time();?>"></script>
</head>
<body>
<!-- stop : header data -->