...
<html>
<head>
<title> <?php echo description(); ?> :: Product KTA UAF  </title> 
...
<script type="text/javascript" src="<?php echo base_ext_form();  ?>/ProductKta.js?version=<?php echo version();?>&&amp;time=<?php echo time();?>"></script>
</head>
<body>
<!-- stop : header data -->