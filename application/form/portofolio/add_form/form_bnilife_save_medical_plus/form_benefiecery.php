 ...
 <fieldset class="corner" style="margin-left:0px; border:0px solid #ddd;">
	...
	<table cellspacing=1> 
		...
		<tr>
			...
			<td><?php echo form()->input( join("_", array("BenefDOB", $cond)), "input_text dfl-disabled benefiecery-dob not-required $selector", $outputs->get_value('BeneficiaryDOB'));?></td>
		</tr>
		
		<tr>
			<td class="text_caption">Age</td>
			<td><?php echo form()->input(join("_", array("BenefAge", $cond)), "input_text dfl-disabled not-required $selector", $outputs->get_value('BeneficiaryAge'));?></td>
		</tr>
