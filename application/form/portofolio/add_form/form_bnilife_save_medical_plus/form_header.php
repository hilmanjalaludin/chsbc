...
<html>
<head>
<title> <?php echo description(); ?> :: Product Bni Life Save Medical Plus  </title> 
...
<script type="text/javascript" src="<?php echo base_ext_helper();?>/EUI.Masking.js?version=<?php echo version();?>&&amp;time=<?php echo time();?>"></script>
<script type="text/javascript" src="<?php echo base_ext_form();  ?>/ProductBniLifeSaveMedicalPlus.js?version=<?php echo version();?>&&amp;time=<?php echo time();?>"></script>
</head>
<body>
<!-- stop : header data -->