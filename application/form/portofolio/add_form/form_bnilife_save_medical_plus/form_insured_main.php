...
<fieldset class="corner" style="margin:5px 5px 10px -5px; padding:5px 8px 15px 8px;border-radius:5px;">
	...
	<div class="ui-widget-form-table">
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell left"><?php echo form()->checkbox("GroupPremi","ui-class-widget-box",$prefixkey, array('click'=> 'SetInsuredChecked(this);'), $checkbox);?> </div>
		</div>
	</div>
	...
	<div class="ui-widget-form-table">	
		...
		<div class="ui-widget-form-row">	
			...
			<div class="ui-widget-form-cell left"><?php echo form()->input(join("_", array("InsuredDOB",$prefixkey)),"input_text long $selector insured-dob dfl-disabled",$outputs->get_value('InsuredDOB'),null,array('disabled'=>true));?></div>
		</div>
		
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption">Age</div>
			<div class="ui-widget-form-cell left"><?php echo form()->input(join("_", array("InsuredAge",$prefixkey)),"input_text long ui-widget-disabled-data  dfl-disabled $selector", $outputs->get_value('InsuredAge'));?></div>
		</div>
		<div class="ui-widget-form-row">
