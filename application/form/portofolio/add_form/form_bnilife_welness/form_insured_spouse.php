...
<?php echo form()->legend(lang("Spouse"),"fa-user");?>
	...
	<div class="ui-widget-form-table">	
		...
		<div class="ui-widget-form-row">	
			...
			<div class="ui-widget-form-cell left"><?php echo form()->input(join("_", array("InsuredDOB",$prefixkey)),"input_text long $selector dfl-disabled insured-dob ui-widget-disabled-data",$outputs->get_value('InsuredDOB'));?></div>
		</div>
