...
?>
	<div class="ui-widget-form-table" style="padding:8px 25px 8px 5px;margin:5px -5px 5px 0px;">	
			...
			<div class="ui-widget-form-row">
				...
				<div class="ui-widget-form-cell left"><?php echo form()->checkbox("GroupPremi",null,join("_", array($prefixkey)), array('click'=> 'SetInsuredChecked(this);'), $checkbox);?> </div>
			</div>
		</div>
		...
		<div class="ui-widget-form-table">	
			...
			<div class="ui-widget-form-row">	
				...
				<div class="ui-widget-form-cell left"><?php echo form()->input(join("_", array("InsuredDOB",$prefixkey)),"input_text long dfl-disabled insured-dob ui-widget-disabled-data $selector", $outputs->get_value('InsuredDOB'));?></div>
			</div>
