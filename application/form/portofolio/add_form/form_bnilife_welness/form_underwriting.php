					...
					AND $frm['type'] == 'checkbox' )
				{
					echo "<div class=\"ui-widget-form-cell table-cell-content center\" style=\"width:20%;\">";
							...
							foreach( $frm['value'] as $key_value => $value ) 
						{
							...
							echo form()->checkbox($InputName, $out->get_value('NodeSeqNo'), $key_value, array("change" => "Ext.Cmp('$InputName').oneChecked(this);new NodeClass(this);"), $arr_extra) ."<span style=\"font-weight:bold;\">{$value}</span> &nbsp; &nbsp;";	
						}	
					echo "</div>";
