...
<div class="ui-widget-form-table">
	...
	<div class="ui-widget-form-row">	
		...
		<div class="ui-widget-form-cell text_caption left">:</div>
		<div class="ui-widget-form-cell"><?php echo form()->input("PayerAge","input_text long text-required uppercase", ( $Payer->get_value('PayerAge','intval') ? $Payer->get_value('PayerAge','intval') : $Payer->get_value('PayerDOB','_getAge')) );?> </div>
	</div>
</div>	
...
<div class="ui-widget-form-table">
	...
	<div class="ui-widget-form-row">	
		...
		<div class="ui-widget-form-cell"> 
			<?php echo form()->input("PayerDOB","input_text date long text-required",$Payer->get_value('PayerDOB','_getDateIndonesia'));?> 
